        ...
        parseDate: function(f, j) {
            ...
            if (j && j !== null && j !== undefined) {
                ...
                for (g = f.length; c < g; c++) {
                    ...
                    if (j[c] !== undefined) h[f[c].toLowerCase()] = parseInt(j[c], 10)
                }
                h.m = parseInt(h.m, 10) - 1;
                c = h.y;
                if (c >= 70 && c <= 99) h.y = 1900 + h.y;
                else if (c >= 0 && c <= 69) h.y = 2E3 + h.y
            }
        ...
        from: function(f) {
            ...
            function(j, h) {
                ...
                this._repeatCommand = function(m, o) {
                    if (x === null) return c;
                    if (m !== null && o !== null) return x(m, o);
                    if (y === null) return x(m);
                    if (!O) return x(m);
                    return x(y, m)
                };
                ...
                this._compare = function(m, o, q) {
                    ...
                    if (m !== null && o === null) return - 1;
                    if (!k && typeof m !== "number" && typeof o !== "number") {
                ...
                this._getOrder = function(m, o, q, B, T) {
                    ...
                    ga = B == "float" || B == "number" || B == "currency" || B == "numeric" ?
                    function(S) {
                    ...
                    //将排序后的列表按照目录和资源分类统一显示--add by jiajianhui 2014-06-08
                    var dirNum=0;
                    var resNum=0;
                    var dirJ=new Array();//排序后的目录
                    var resJ=new Array();//排序后的资源
                    $(J).each(function(k,v){
                        if($(J[k].type).html()=="目录"){
                            dirJ[dirNum]=J[k];
                            dirNum++;
                    ...
                    J=dirJ.concat(resJ);
                    //重新创建更多操作
                    if("undefined"!=typeof(moreops) && (moreops!=null && moreops!="")){
                ...
                this._compareValues = function(m, o, q, B, T) {
                    var J;
                    J = O ? "jQuery.jgrid.getAccessor(this,'" + o + "')": "this";
                    if (q === undefined) q = null;
                    var D = q,
                    W = T.stype === undefined ? "text": T.stype;
                    if (q !== null) switch (W) {
                    case "int":
                    case "integer":
                ...
                this.less = function(m, o, q) {
                    return c._compareValues(c.less, m, o, "<", q)
                };
                ...
                this.startsWith = function(m, o) {
                    ...
                    if (O) c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + m + "')") + ".substr(0," + q + ") == " + c._getStr('"' + c._toStr(o) + '"'));
                    else {
                        q = l ? b.trim(o.toString()).length: o.toString().length;
                        c._append(c._getStr("this") + ".substr(0," + q + ") == " + c._getStr('"' + c._toStr(m) + '"'))
                    }
                ...
                this.endsWith = function(m, o) {
                    var q = o === undefined || o === null ? m: o;
                    q = l ? b.trim(q.toString()).length: q.toString().length;
                    O ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + m + "')") + ".substr(" + c._getStr("jQuery.jgrid.getAccessor(this,'" + m + "')") + ".length-" + q + "," + q + ') == "' + c._toStr(o) + '"') : c._append(c._getStr("this") + ".substr(" + c._getStr("this") + '.length-"' + c._toStr(m) + '".length,"' + c._toStr(m) + '".length) == "' + c._toStr(m) + '"');
            ...
            if (!this.grid) {
                var c = b.extend(true, {
                    ...
                    groupingView: {
                        ...
                        summary: [],
                        summaryval: [],
                        plusicon: "ui-icon-groupGrid-plus",
                        minusicon: "ui-icon-groupGrid-minus"
                    },
                    ignoreCase: false,
                    cmTemplate: {}
                },
                ...
                g = {
                    ...
                    dragMove: function(e) {
                        if (this.resizing) {
                            ...
                            var i = c.direction === "ltr" ? e.width + d: e.width - d,
                            n;
                            if (i > 33) {
                                this.curGbox.css({
                    ...
                    dragEnd: function() {
                        ...
                        if (this.resizing) {
                            ...
                            d = this.headers[e].newWidth || this.headers[e].width;
                            d = parseInt(d, 10);
                            this.resizing = false;
                    ...
                    populateVisible: function() {
                        ...
                        if (e) {
                            ...
                            if (n) {
                                ...
                                var s = Math.round(d.position().top) - i,
                                F = s + d.height();
                                n *= A;
                                var t, z, v;
                                if (F < e && s <= 0 && (c.lastpage === undefined || parseInt((F + i + n - 1) / n, 10) <= c.lastpage)) {
                                    z = parseInt((e - F + n - 1) / n, 10);
                                    if (F >= 0 || z < 2 || c.scroll === true) {
                                ...
                                if (s > 0) {
                                    t = parseInt(i / n, 10) + 1;
                                    z = parseInt((i + e) / n, 10) + 2 - t;
                                    v = true
                                }
                                if (z) if (! (c.lastpage && t > c.lastpage || c.lastpage == 1 || t === c.page && t === c.lastpage)) if (g.hDiv.loading) g.timer = setTimeout(g.populateVisible, c.scrollTimeout);
                                else {
                                    c.page = t;
                                    if (v) {
                    ...
                    selectionPreserver: function(e) {
                        var d = e.p,
                        i = d.selrow,
                        n = d.selarrrow ? b.makeArray(d.selarrrow) : null,
                ...
                if (this.tagName.toUpperCase() != "TABLE") alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var r = b("<div class='ui-jqgrid-view'></div>"),
                        x,
                        ...
                        b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").append(x).insertBefore(r);
                        ...
                        O = function(e, d, i, n, p, A) {
                            ...
                            if (d === 0) t += "width: " + g.headers[e].width + "px;";
                            else if (s.cellattr && b.isFunction(s.cellattr)) if ((e = s.cellattr.call(a, p, i, n, s, A)) && typeof e === "string") {
                                e = e.replace(/style/i, "style").replace(/title/i, "title");
                                if (e.indexOf("title") > -1) s.title = false;
                                if (e.indexOf("class") > -1) z = undefined;
                                u = e.split("style");
                                if (u.length === 2) {
                                    u[1] = b.trim(u[1].replace("=", ""));
                                    if (u[1].indexOf("'") === 0 || u[1].indexOf('"') === 0) u[1] = u[1].substring(1);
                                    t += u[1].replace(/'/gi, '"')
                                } else t += '"'
                            }
                            if (!u.length) {
                            ...
                            t += (z !== undefined ? ' class="' + z + '"': "") + (s.title && i ? ' title="' + b.jgrid.stripHtml(i) + '"': "");
                            t += ' aria-describedby="' + a.p.id + "_" + v + '"';
                            return t + u[0]
                        },
                        m = function(e) {
                        ...
                        ga = function(e, d, i, n, p) {
                            ...
                            F = a.p.datatype == "local" ? "local": "xml";
                            if (s) {
                                a.p.data = [];
                                a.p._index = {};
                            ...
                            if (b.isXMLDoc(e)) {
                                ...
                                C,
                                H = [],
                                ha = a.p.altRows === true ? " " + a.p.altclass: "";
                                ...
                                if (e && V) {
                                    ...
                                    var oa = "";
                                    if (a.p.grouping && a.p.groupingView.groupCollapse === true) oa = ' style="display:none;"';
                                    for (; Z < V;) {
                                        w = e[Z];
                                        C = F(w, ra + Z);
                                        t = i === 0 ? 0 : i + 1;
                                        ...
                                        if (a.p.xmlReader.repeatitems) {
                                            Y || (Y = D(G + R + M));
                                            var Ba = b(a.p.xmlReader.cell, w);
                                            b.each(Y,
                                            function(ea) {
                                                var $ = Ba[this];
                                                if (!$) return false;
                                                u = $.textContent || $.text;
                                                I[a.p.colModel[ea + G + R + M].name] = u;
                                                H.push(q(C, u, ea + G + R + M, Z + i, w))
                                            })
                                        } else for (t = 0; t < N.length; t++) {
                                            u = b(N[t], w).text();
                                            I[a.p.colModel[t + G + R + M].name] = u;
                                            H.push(q(C, u, t + G + R + M, Z + i, w))
                                        }
                                        H.push("</tr>");
                                        if (a.p.grouping) {
                                        ...
                                        if (a.p.gridview === false) {
                                            ...
                                            p && a.p.afterInsertRow.call(a, C, I, w);
                                            H = []
                                        }
                                        I = {};
                                        v++;
                                ...
                                if (a.p.gridview === true) {
                                    z = a.p.treeANode > -1 ? a.p.treeANode: 0;
                                    if (a.p.grouping) {
                                        b(a).jqGrid("groupingRender", ia, a.p.colModel.length);
                                        ia = null
                                    } else a.p.treeGrid === true && z > 0 ? b(a.rows[z]).after(H.join("")) : b("tbody:first", d).append(H.join(""))
                                }
                                if (a.p.subGrid === true) try {
                                    b(a).jqGrid("addSubGrid", G + M)
                                } catch(Ha) {}
                                a.p.totaltime = new Date - A;
                                if (v > 0) if (a.p.records === 0) a.p.records = V;
                                H = null;
                                if (a.p.treeGrid === true) try {
                                    b(a).jqGrid("setTreeNode", z + 1, v + z + 1)
                                } catch(Ia) {}
                        ...
                        ca = function(e, d, i, n, p) {
                            ...
                            if (e) {
                                ...
                                if (u.length > 0 && !isNaN(s)) {
                                    ...
                                    s = u[s]
                                } (Y = b.jgrid.getAccessor(e, d.root)) || (Y = []);
                                N = Y.length;
                                e = 0;
                                var V = parseInt(a.p.rowNum, 10),
                                Z = a.p.scroll ? b.jgrid.randId() : 1;
                                if (p) V *= p + 1;
                                var ia = b.isFunction(a.p.afterInsertRow),
                                fa = {},
                                ra = "";
                                ...
                                for (; e < N;) {
                                    ...
                                    if (C === undefined) {
                                        C = Z + e;
                                        if (u.length === 0) if (d.cell) C = b.jgrid.getAccessor(p, d.cell)[s] || C
                                    }
                                    z = i === 1 ? 0 : i;
                                    z = (z + e) % 2 == 1 ? ha: "";
                                    H.push("<tr" + ra + ' id="' + C + '" tabindex="-1" role="row" class= "ui-widget-content jqgrow ui-row-' + a.p.direction + "" + z + '">');
                                    if (a.p.rownumbers === true) {
                                    ...
                                    if (a.p.subGrid) {
                                        H.push(b(a).jqGrid("addSubGridCell", R + L, e + i));
                                        M = 1
                                    }
                                    if (d.repeatitems) {
                                    ...
                                    for (v = 0; v < G.length; v++) {
                                        z = b.jgrid.getAccessor(p, G[v]);
                                        H.push(q(C, z, v + R + M + L, e + i, p));
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        v = [];
                                        for (var oa = 0; oa < z; oa++) v.push(I[a.p.groupingView.groupField[oa]]);
                                        fa = b(a).jqGrid("groupingPrepare", H, v, fa, I);
                                        H = []
                                    }
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) b(a).jqGrid("groupingRender", fa, a.p.colModel.length);
                                    else a.p.treeGrid === true && w > 0 ? b(a.rows[w]).after(H.join("")) : b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(H.join(""))
                                }
                                if (a.p.subGrid === true) try {
                                    b(a).jqGrid("addSubGrid", R + L)
                                } catch(Ba) {}
                                a.p.totaltime = new Date - A;
                                if (t > 0) if (a.p.records === 0) a.p.records = N;
                                if (a.p.treeGrid === true) try {
                                    b(a).jqGrid("setTreeNode", w + 1, t + w + 1)
                                } catch(xa) {}
                                if (!a.p.treeGrid && !a.p.scroll) a.grid.bDiv.scrollTop = 0;
                                a.p.reccount = t;
                                a.p.treeANode = -1;
                        ...
                        S = function() {
                            function e(w) {
                                var C = 0,
                                H, ha, V;
                                if (w.groups !== undefined) for (H = 0; H < w.groups.length; H++) {
                                    try {
                                        e(w.groups[H])
                                    } catch(Z) {
                                        alert(Z)
                                ...
                                if (w.rules !== undefined) {
                                    ...
                                    try {
                                        for (H = 0; H < w.rules.length; H++) {
                                            V = w.rules[H];
                                            ha = w.groupOp.toString().toUpperCase();
                                            if (v[V.op] && V.field) {
                                                if (C > 0 && ha && ha === "OR") u = u.or();
                                                u = v[V.op](u, ha)(V.field, V.data, n[V.field])
                                            }
                                            C++
                                        }
                                    } catch(fa) {
                            ...
                            if (b.isArray(a.p.data)) {
                                var z = a.p.grouping ? a.p.groupingView: false;
                                b.each(a.p.colModel,
                                function() {
                                    ...
                                    if (a.p.grouping && this.name == z.groupField[0]) {
                                        var w = this.name;
                                        if (typeof this.index != "undefined") w = this.index;
                                        p[0] = n[w];
                                        A.push(w)
                                    }
                                    if (!i && (this.index == a.p.sortname || this.name == a.p.sortname)) {
                                        d = this.name;
                                        i = true
                                    }
                                });
                                if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, n[d].stype, n[d].srcfmt);
                                else {
                                    var v = {
                                        eq: function(w) {
                                            return w.equals
                                        ...
                                        le: function(w) {
                                            return w.lessOrEquals
                                        },
                                        gt: function(w) {
                                            return w.greater
                                        },
                                        ge: function(w) {
                                            return w.greaterOrEquals
                                        },
                                        cn: function(w) {
                                            return w.contains
                                        },
                                        nc: function(w, C) {
                                            return C === "OR" ? w.orNot().contains: w.andNot().contains
                                        },
                                        bw: function(w) {
                                            return w.startsWith
                                        },
                                        bn: function(w, C) {
                                            return C === "OR" ? w.orNot().startsWith: w.andNot().startsWith
                                        },
                                        en: function(w, C) {
                                            return C === "OR" ? w.orNot().endsWith: w.andNot().endsWith
                                        },
                                        ew: function(w) {
                                            return w.endsWith
                                        },
                                        ni: function(w, C) {
                                            return C === "OR" ? w.orNot().equals: w.andNot().equals
                                        },
                                        "in": function(w) {
                                            return w.equals
                                        },
                                        ...
                                        nn: function(w, C) {
                                            return C === "OR" ? w.orNot().isNull: w.andNot().isNull
                                        }
                                    },
                                    u = b.jgrid.from(a.p.data);
                                    if (a.p.ignoreCase) u = u.ignoreCase();
                                    if (a.p.search === true) {
                                        ...
                                        if (G) {
                                            ...
                                            u = v[a.p.postData.searchOper](u)(a.p.postData.searchField, a.p.postData.searchString, n[a.p.postData.searchField])
                                        } catch(R) {}
                                    }
                                    if (a.p.grouping) {
                                        u.orderBy(A, z.groupOrder[0], p[0].stype, p[0].srcfmt);
                                        z.groupDataSorted = true
                                    }
                                    if (d && a.p.sortorder && i) a.p.sortorder.toUpperCase() == "DESC" ? u.orderBy(a.p.sortname, "d", n[d].stype, n[d].srcfmt) : u.orderBy(a.p.sortname, "a", n[d].stype, n[d].srcfmt);
                                    G = u.select();
                                    var M = parseInt(a.p.rowNum, 10),
                                    L = G.length,
                                    N = parseInt(a.p.page, 10),
                                    Y = Math.ceil(L / M),
                                    I = {};
                                    G = G.slice((N - 1) * M, N * M);
                                    n = u = null;
                        ...
                        ja = function(e) {
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (a.p.rowTotal !== null && p.totalrows !== null) i[p.totalrows] = a.p.rowTotal;
                                var A = a.p.loadComplete,
                                s = b.isFunction(A);
                                s || (A = null);
                                var F = 0;
                                e = e || 1;
                                ...
                                var t = !a.p.scroll ? 1 : a.rows.length - 1;
                                if (b.isFunction(a.p.datatype)) a.p.datatype.call(a, a.p.postData, "load_" + a.p.id);
                                    ...
                                    case "script":
                                        b.ajax(b.extend({
                                            ...
                                            success: function(z) {
                                                n === "xml" ? ga(z, a.grid.bDiv, t, e > 1, F) : ca(z, a.grid.bDiv, t, e > 1, F);
                                                A && A.call(a, z);
                                                d && a.grid.populateVisible();
                                                if (a.p.loadonce || a.p.treeGrid) a.p.datatype = "local";
                                                pa()
                                            },
                                            error: function(z, v, u) {
                                                b.isFunction(a.p.loadError) && a.p.loadError.call(a, z, v, u);
                                                pa()
                                            },
                                            beforeSend: function(z) {
                                                aa();
                                                b.isFunction(a.p.loadBeforeSend) && a.p.loadBeforeSend.call(a, z)
                                            }
                                        },
                                    ...
                                    case "jsonstring":
                                        aa();
                                        i = typeof a.p.datastr == "string" ? b.jgrid.parse(a.p.datastr) : a.p.datastr;
                                        ca(i, a.grid.bDiv);
                                        s && a.p.loadComplete.call(a, i);
                                        a.p.datatype = "local";
                                        a.p.datastr = null;
                        ...
                        x = function(e, d) {
                            var i = "",
                            n = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
                            p = "",
                            A, s, F, t, z = function(v) {
                                var u;
                                if (b.isFunction(a.p.onPaging)) u = a.p.onPaging.call(a, v);
                                a.p.selrow = null;
                                if (a.p.multiselect) {
                                    a.p.selarrrow = [];
                            ...
                            F = e + "_center";
                            t = e + "_right";
                            b("#" + b.jgrid.jqID(e)).append("<div id='" + A + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + s + "' align='left'></td><td id='" + F + "' align='center' style='white-space:pre;'></td><td id='" + t + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                            ...
                            if (l == "rtl") n += p;
                            if (a.p.pginput === true) i = "<td dir='" + l + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(e) + "'></span>") + "</td>";
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + b.jgrid.jqID(d) + ", #prev" + b.jgrid.jqID(d) + ", #next" + b.jgrid.jqID(d) + ", #last" + b.jgrid.jqID(d)).click(function() {
                                    ...
                                    L = true,
                                    N = true;
                                    if (u === 0 || u === 1) N = L = M = R = false;
                                    else if (u > 1 && v >= 1) if (v === 1) M = R = false;
                                    else {
                                        if (! (v > 1 && v < u)) if (v === u) N = L = false
                                    } else if (u > 1 && v === 0) {
                                        N = L = false;
                                        v = u - 1
                                    }
                                    if (this.id === "first" + d && R) {
                                        a.p.page = 1;
                                        G = true
                                    }
                                    if (this.id === "prev" + d && M) {
                                    ...
                                    if (G) {
                                        if (!z(this.id)) return false;
                                        ja()
                                    }
                                    return false
                                })
                            }
                            a.p.pginput === true && b("input.ui-pg-input", "#" + A).keypress(function(v) {
                                if ((v.charCode ? v.charCode: v.keyCode ? v.keyCode: 0) == 13) {
                                    a.p.page = b(this).val() > 0 ? b(this).val() : a.p.page;
                                    if (!z("user")) return false;
                                    ja();
                                    return false
                                }
                                return this
                        ...
                        var Ca = function(e, d, i, n) {
                            if (a.p.colModel[d].sortable) if (! (a.p.savedRow.length > 0)) {
                                ...
                                if (n) if (a.p.lastsort == d && a.p.sortorder == n && !i) return;
                                else a.p.sortorder = n;
                                ...
                                if (!a.p.viewsortcols[0]) if (a.p.lastsort != d) {
                                    b("tr th:eq(" + a.p.lastsort + ") span.s-ico", i).hide();
                        ...
                        Fa = function(e) {
                            ...
                            if (b(a.grid.cDiv).is(":visible")) i[1] += b(a.grid.cDiv).height() + parseInt(b(a.grid.cDiv).css("padding-top"), 10) + parseInt(b(a.grid.cDiv).css("padding-bottom"), 10);
                        ...
                        if (this.p.multiselect) {
                            //this.p.colNames.unshift("<input role='checkbox' id='cbv_" + this.p.id + "' class='cbox' type='checkbox'/>");
                            this.p.colNames.unshift("<div id='checkDiv"+this.p.id+"'></div>");
                            this.p.colModel.unshift({
                                ...
                                hidedlg: true,
                                search: false,
//                                align: "center", // 居中对齐 IE7 IE8兼容模式 不对。
                                fixed: true
                            })
                        }
                        ...
                        a.p.data.length && U();
                        var ba = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
                        Da, ma, sa, qa, ta, X, P, na;
                        ma = na = "";
                        ...
                        for (k = 0; k < this.p.colNames.length; k++) {
                            ...
                            ba += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[k].name + "' " + Da + ">" + a.p.colNames[k];
                        ...
                        if (a.p.autowidth === true) {
                            ...
                            if (isNaN(a.p.width)) a.p.width = g.width = e;
                            ...
                            if (a.p.shrinkToFit === true && i > 0) {
                                ...
                                v = 0;
                                if (s) {
                                    if (g.width - t - (e + d * i) !== p) v = g.width - t - (e + d * i) - p
                                } else if (!s && Math.abs(g.width - t - (e + d * i)) !== 1) v = g.width - t - (e + d * i);
                                a.p.colModel[n].width += v;
                                a.p.tblwidth = e + v + d * i + t;
                        ...
                        b(Q).css("width", g.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + a.p.id + "'>&#160;</div>");
                        ...
                        b("th", r).each(function(e) {
                            ...
                            if (a.p.footerrow) va += "<td role='gridcell' " + O(e, 0, "", null, "", false) + ">&#160;</td>"
                        ...
                        wa = null;
                        r = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(ba);
                        ...
                        function(e) {
                            P = b(e.target).closest("tr.jqgrow");
                            b(P).attr("class") !== "subgrid" && b(P).addClass("ui-state-hover");
                            return false
                        }).bind("mouseout",
                        function(e) {
                            P = b(e.target).closest("tr.jqgrow");
                        ...
                        b(a).before(g.hDiv).click(function(e) {
                            X = e.target;
                            P = b(X, a.rows).closest("tr.jqgrow");
                            if (b(P).length === 0 || P[0].className.indexOf("ui-state-disabled") > -1) return this;
                            var d = b(X).hasClass("cbox"),
                            i = true;
                            if (b.isFunction(a.p.beforeSelectRow)) i = a.p.beforeSelectRow.call(a, P[0].id, e);
                            if (X.tagName == "A" || (X.tagName == "INPUT" || X.tagName == "TEXTAREA" || X.tagName == "OPTION" || X.tagName == "SELECT") && !d) return this;
                            if (i === true) {
                                if (a.p.cellEdit === true) if (a.p.multiselect && d) b(a).jqGrid("setSelection", P[0].id, true);
                                else {
                                    ka = P[0].rowIndex;
                                ...
                                } else if (a.p.multikey) if (e[a.p.multikey]) b(a).jqGrid("setSelection", P[0].id, true);
                                else {
                                    if (a.p.multiselect && d) {
                                        d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + P[0].id).attr("checked");
                                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + P[0].id).attr("checked", !d)
                                    }
                                } else {
                                    ...
                                    b(a).jqGrid("setSelection", P[0].id, true)
                                }
                        ...
                        b.isFunction(this.p.ondblClickRow) && b(this).dblclick(function(e) {
                            X = e.target;
                            P = b(X, a.rows).closest("tr.jqgrow");
                            if (b(P).length === 0) return false;
                            ka = P[0].rowIndex;
                            la = b.jgrid.getCellIndex(X);
                            a.p.ondblClickRow.call(a, b(P).attr("id"), ka, la, e);
                            return false
                        });
                        ...
                        function(e) {
                            ...
                            P = b(X, a.rows).closest("tr.jqgrow");
                            if (b(P).length === 0) return false;
                            a.p.multiselect || b(a).jqGrid("setSelection", P[0].id, true);
                            ka = P[0].rowIndex;
                            la = b.jgrid.getCellIndex(X);
                            a.p.onRightClickRow.call(a, b(P).attr("id"), ka, la, e);
                            return false
                        });
                        g.bDiv = document.createElement("div");
                        if (y) if (String(a.p.height).toLowerCase() === "auto") a.p.height = "100%";
                        b(g.bDiv).append(b('<div style="position:relative;' + (y && b.browser.version < 8 ? "height:0.01%;": "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                        ...
                        if (a.p.caption) {
                            ...
                            if (a.p.hidegrid === true) {
                                b(".ui-jqgrid-titlebar-close", g.cDiv).click(function(e) {
                                    ...
                                    i = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",
                                    n,
                                    p = this;
                                    ...
                                    if (a.p.gridstate == "visible") b(i, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp("fast",
                                    function() {
                                        n--;
                                        if (n === 0) {
                                    ...
                                    else a.p.gridstate == "hidden" && b(i, "#gbox_" + b.jgrid.jqID(a.p.id)).slideDown("fast",
                                    function() {
                                        n--;
                                        if (n === 0) {
                        ...
                        a.updatepager = function(e, d) {
                            var i, n, p, A, s, F, t, z = "",
                            v = a.p.pager ? "_" + b.jgrid.jqID(a.p.pager.substr(1)) : "",
                            u = a.p.toppager ? "_" + a.p.toppager.substr(1) : "";
                            ...
                            z += a.p.toppager ? z ? "," + a.p.toppager: a.p.toppager: "";
                            if (z) {
                                t = b.jgrid.formatter.integer || {};
                                i = K(a.p.page);
                                n = K(a.p.lastpage);
                                b(".selbox", z).attr("disabled", false);
                                if (a.p.pginput === true) {
                                    b(".ui-pg-input", z).val(a.p.page);
                                    A = a.p.toppager ? "#sp_1" + v + ",#sp_1" + u: "#sp_1" + v;
                                    b(A).html(b.fmatter ? b.fmatter.util.NumberFormat(a.p.lastpage, t) : a.p.lastpage)
                                }
                                if (a.p.viewrecords) if (a.p.reccount === 0) b(".ui-paging-info", z).html(a.p.emptyrecords);
                                else {
                                    A = p + 1;
                                    F = a.p.records;
                                    if (b.fmatter) {
                                    ...
                                    b(".ui-paging-info", z).html(b.jgrid.format(a.p.recordtext, A, s, F))
                                }
                                if (a.p.pgbuttons === true) {
                                    if (i <= 0) i = n = 0;
                                    if (i == 1 || i === 0) {
                                        b("#first" + v + ", #prev" + v).addClass("ui-state-disabled").removeClass("ui-state-hover");
                                        a.p.toppager && b("#first_t" + u + ", #prev_t" + u).addClass("ui-state-disabled").removeClass("ui-state-hover")
                                    } else {
                                        b("#first" + v + ", #prev" + v).removeClass("ui-state-disabled");
                                        a.p.toppager && b("#first_t" + u + ", #prev_t" + u).removeClass("ui-state-disabled")
                                    }
                                    if (i == n || i === 0) {
                                        b("#next" + v + ", #last" + v).addClass("ui-state-disabled").removeClass("ui-state-hover");
                                        a.p.toppager && b("#next_t" + u + ", #last_t" + u).addClass("ui-state-disabled").removeClass("ui-state-hover")
                                    } else {
                                        b("#next" + v + ", #last" + v).removeClass("ui-state-disabled");
                                        a.p.toppager && b("#next_t" + u + ", #last_t" + u).removeClass("ui-state-disabled")
                                    }
                                }
                            }
    ...
    b.jgrid.extend({
        ...
        setSelection: function(f, j) {
            return this.each(function() {
                function h(a) {
                    var r = b(c.grid.bDiv)[0].clientHeight,
                    x = b(c.grid.bDiv)[0].scrollTop,
                    y = c.rows[a].offsetTop;
                    a = c.rows[a].clientHeight;
                    if (y + a >= r + x) b(c.grid.bDiv)[0].scrollTop = y - (r + x) + a + x;
                    else if (y < r + x) if (y < x) b(c.grid.bDiv)[0].scrollTop = y
                }
                var c = this,
                g, k, l;
                if (f !== undefined) {
                    j = j === false ? false: true;
                    k = c.rows.namedItem(f + "");
            ...
            this.each(function() {
                ...
                if (j) try {
                    b(this.p.colModel).each(function(O) {
                        c = this.name;
                        if (j[c] !== undefined) {
                            y[c] = this.formatter && typeof this.formatter === "string" && this.formatter == "date" ? b.unformat.date(j[c], this) : j[c];
                    ...
                    if (l.p.datatype == "local") {
                        var E = l.p._index[f];
                        if (l.p.treeGrid) for (var Q in l.p.treeReader) y.hasOwnProperty(l.p.treeReader[Q]) && delete y[l.p.treeReader[Q]];
                ...
                if (g) if (x === "string") b(r).addClass(h);
                else x === "object" && b(r).css(h)
            });
            return g
        },
        addRowData: function(f, j, h, c) {
            ...
            if (j) {
                ...
                this.each(function() {
                    ...
                    if (!O) if (typeof f != "undefined") f += "";
                    else {
                        f = b.jgrid.randId();
                        if (this.p.keyIndex !== false) {
                            m = this.p.colModel[this.p.keyIndex + a + r + x].name;
                    ...
                    D = "",
                    W = {},
                    U = b.isFunction(this.p.afterInsertRow) ? true: false; J < T;) {
                        q = j[J];
                        l = "";
                        if (O) {
                            try {
                        ...
                        if (a) {
                            Q = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + f + '" class="cbox"/>';
                            K = this.formatCol(x, 1, "", null, f, true);
                            l += '<td role="gridcell" aria-describedby="' + this.p.id + '_cb" ' + K + ">" + Q + "</td>"
                        }
                        if (r) l += b(this).jqGrid("addSubGridCell", a + x, 1);
                        for (E = a + r + x; E < this.p.colModel.length; E++) {
                            B = this.p.colModel[E];
                            k = B.name;
                            W[k] = B.formatter && typeof B.formatter === "string" && B.formatter == "date" ? b.unformat.date(q[k], B) : q[k];
                            Q = this.formatter(f, b.jgrid.getAccessor(q, k), E, q, "edit");
                            K = this.formatCol(E, 1, Q, f, q, true);
                            l += '<td role="gridcell" aria-describedby="' + this.p.id + "_" + k + '" ' + K + ">" + Q + "</td>"
                        }
                        ...
                        this.p.records++;
                        this.p.reccount++;
                        U && this.p.afterInsertRow.call(this, f, q, q);
                        J++;
                        if (this.p.datatype == "local") {
                    ...
                    if (this.p.altRows === true && !O) if (h == "last")(this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(o);
                    else b(this.rows).each(function(ca) {
        ...
        footerData: function(f, j, h) {
            function c(r) {
                for (var x in r) if (r.hasOwnProperty(x)) return false;
                return true
            }
            var g, k = false,
            l = {},
            ...
            this.each(function() {
                ...
                b(this.p.colModel).each(function(y) {
                    ...
                    if (f == "set") {
                        if (j[g] !== undefined) {
                            x = h ? r.formatter("", j[g], y, j, "edit") : j[g];
                            a = this.title ? {
                                title: b.jgrid.stripHtml(x)
                            }: {};
                            b("tr.footrow td:eq(" + y + ")", r.grid.sDiv).html(x).attr(a);
                            k = true
                        }
                    } else if (f == "get") l[g] = b("tr.footrow td:eq(" + y + ")", r.grid.sDiv).html()
                })
            });
            return f == "get" ? l: k
        },
        showHideCol: function(f, j) {
            return this.each(function() {
                var h = this,
                c = false,
                g = b.browser.webkit || b.browser.safari ? 0 : h.p.cellLayout,
                k;
                if (h.grid) {
                    ...
                    b(this.p.colModel).each(function(a) {
                        if (b.inArray(this.name, f) !== -1 && this.hidden === l) {
                            ...
                            h.p.footerrow && b(h.grid.sDiv).children("td:eq(" + a + ")").css("display", j);
                            k = this.widthOrg ? this.widthOrg: parseInt(this.width, 10);
                            if (j === "none") h.p.tblwidth -= k + g;
                            else h.p.tblwidth += k + g;
                            this.hidden = !l;
                            c = true
                        }
                    });
                    if (c === true) if (h.p.shrinkToFit === false) b(h).jqGrid("setGridWidth", h.grid.width);
                    else h.grid.width !== h.p.tblwidth && b(h).jqGrid("setGridWidth", h.p.tblwidth)
                }
            })
        },
        hideCol: function(f) {
        ...
        setGridWidth: function(f, j) {
            return this.each(function() {
                if (this.grid) {
                    var h = this,
                    c, g = 0,
                    k = b.browser.webkit || b.browser.safari ? 0 : h.p.cellLayout,
                    l,
                    a = 0,
                    r = false,
                    x = h.p.scrollOffset,
                    ...
                    if (!isNaN(f)) {
                        ...
                        b("#gbox_" + b.jgrid.jqID(h.p.id)).css("width", f + "px");
                        ...
                        if (j === true) {
                            ...
                            function(m) {
                                if (this.hidden === false && !this.fixed) {
                                    c = this.widthOrg ? this.widthOrg: parseInt(this.width, 10);
                                    c = Math.round(y * c / (h.p.tblwidth - k * a - E));
                                    if (! (c < 0)) {
                                        this.width = c;
                                        g += c;
                                        h.grid.headers[m].width = c;
                            ...
                            if (O) h.grid.cols[l].style.width = c + "px";
                            if (h.p.footerrow) h.grid.footers[l].style.width = c + "px"
                        }
                        if (h.p.tblwidth) {
                            ...
                            h.p.footerrow && b("table:first", h.grid.sDiv).css("width", h.p.tblwidth + "px")
                        }
                    }
                }
            })
        ...
        setLabel: function(f, j, h, c) {
            return this.each(function() {
                var g = -1;
                if (this.grid) if (typeof f != "undefined") {
                    b(this.p.colModel).each(function(a) {
                        if (this.name == f) {
                            g = a;
                            return false
        ...
        setCell: function(f, j, h, c, g, k) {
            return this.each(function() {
                ...
                a, r;
                if (this.grid) {
                    if (isNaN(j)) b(this.p.colModel).each(function(y) {
                        if (this.name == j) {
                            l = y;
                            return false
                        }
                    ...
                    if (l >= 0) if (a = this.rows.namedItem(f)) {
                        ...
                        if (h !== "" || k === true) {
                            ...
                            r = this.p.colModel[l].title ? {
                                title: b.jgrid.stripHtml(a)
                            }: {};
                            this.p.treeGrid && b(".tree-wrap", b(x)).length > 0 ? b("span", b(x)).html(a).attr(r) : b(x).html(a).attr(r);
                            if (this.p.datatype == "local") {
                                a = this.p.colModel[l];
                        ...
                        if (y && y > 0) {
                            for (; E < y;) {
                                if (b(this.rows[E]).hasClass("jqgrow")) {
                                    try {
                                        g = b.unformat(b(this.rows[E].cells[x]), {
                                            rowId: this.rows[E].id,
                                            colModel: this.p.colModel[x]
                                        },
                                        x)
                                    } catch(Q) {
                                        g = b.jgrid.htmlDecode(this.rows[E].cells[x].innerHTML)
                                    }
                                    if (h) {
                                        r = parseFloat(g);
                                        k += r;
        ...
        getInd: function(f, j) {
            ...
            c;
            this.each(function() {
                if (c = this.rows.namedItem(f)) h = j === true ? c: c.rowIndex
            });
            return h
        },
        bindKeys: function(f) {
            ...
            return this.each(function() {
                ...
                b(h).keydown(function(c) {
                    ...
                    l,
                    a,
                    r = h.p.treeReader.expanded_field;
                    if (g) {
                        a = h.p._index[g.id];
                        if (c.keyCode === 37 || c.keyCode === 38 || c.keyCode === 39 || c.keyCode === 40) {
                            ...
                            if (c.keyCode === 37) {
                                ...
                                b.isFunction(j.onLeftKey) && j.onLeftKey.call(h, h.p.selrow)
                            }
                            if (c.keyCode === 39) {
                                h.p.treeGrid && !h.p.data[a][r] && b(g).find("div.treeclick").trigger("click");
    ...
    b.fmatter.util = {
        ...
        DateFormat: function(a, c, d, e) {
            ...
            p = i.getFullYear(),
            q = (n + 6) % 7 + 1,
            s = (new Date(p, g - 1, h) - new Date(p, 0, 1)) / 864E5,
            t = {
                d: f(h),
                D: k.i18n.dayNames[n],
                j: h,
                ...
                a: a < 12 ? e.AmPm[0] : e.AmPm[1],
                A: a < 12 ? e.AmPm[2] : e.AmPm[3],
                B: "?",
                g: a % 12 || 12,
                G: a,
                h: f(a % 12 || 12),
    ...
    b.fn.fmatter.link = function(a, c) {
        ...
        return b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : "<a " + e + ' href="' + a + '">' + a + "</a>"
    };
    b.fn.fmatter.showlink = function(a, c) {
        ...
        return b.fmatter.isString(a) || b.fmatter.isNumber(a) ? "<a " + e + ' href="' + d + '">' + a + "</a>": b.fn.fmatter.defaultFormat(a, c)
    };
    ...
    b.fn.fmatter.date = function(a, c, d, e) {
        ...
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d = b.extend({},
        d, c.colModel.formatoptions));
        return ! d.reformatAfterEdit && e == "edit" ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.util.DateFormat(d.srcformat, a, d.newformat, d)
    };
    b.fn.fmatter.select = function(a, c) {
        ...
        if (d) {
            var f = c.colModel.editoptions.multiple === true ? true: false,
            g = [],
            h;
            if (f) {
                g = a.split(",");
            ...
            } else if (b.fmatter.isObject(d)) if (f) e = jQuery.map(g,
            function(l) {
                return d[l]
            });
            else e[0] = d[a] || ""
    ...
    b.fn.fmatter.rowactions = function(a, c, d, e) {
        ...
        if (!b.fmatter.isUndefined(b("#" + c)[0].p.editOptions)) f.editOptions = b("#" + c)[0].p.editOptions;
        if (!b.fmatter.isUndefined(b("#" + c)[0].p.delOptions)) f.delOptions = b("#" + c)[0].p.delOptions;
        e = function(h) {
        ...
        switch (d) {
        case "edit":
            b("#" + c).jqGrid("editRow", a, f.keys, f.onEdit, f.onSuccess, f.url, f.extraparam, e, f.onError, g);
        ...
        case "formedit":
            ...
            b("#" + c).jqGrid("editGridRow", a, f.editOptions)
        }
    };
    b.fn.fmatter.actions = function(a, c) {
        ...
        if (d.editformbutton) {
            g = "onclick=$.fn.fmatter.rowactions('" + e + "','" + c.gid + "','formedit'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
            ...
            g = "onclick=$.fn.fmatter.rowactions('" + e + "','" + c.gid + "','edit'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ";
            f = f + "<div style='margin-left:8px;'><div title='" + b.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g + "><span class='ui-icon ui-icon-pencil'></span></div>"
        }
        if (d.delbutton) {
        ...
        g = "onclick=$.fn.fmatter.rowactions('" + e + "','" + c.gid + "','save'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
        ...
        g = "onclick=$.fn.fmatter.rowactions('" + e + "','" + c.gid + "','cancel'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
    ...
    b.unformat = function(a, c, d, e) {
        ...
        if (typeof j !== "undefined" && b.isFunction(j)) f = j(b(a).text(), c, a);
        else if (!b.fmatter.isUndefined(g) && b.fmatter.isString(g)) {
            f = b.jgrid.formatter || {};
            switch (g) {
            case "integer":
                h = b.extend({},
    ...
    a.jgrid.extend({
        ...
        setColProp: function(c, h) {
            return this.each(function() {
                if (this.grid) if (h) for (var b = this.p.colModel,
                i = 0; i < b.length; i++) if (b[i].name == c) {
        ...
        sortGrid: function(c, h, b) {
            return this.each(function() {
                ...
                if (this.grid) {
                    ...
                    for (var o = 0; o < this.p.colModel.length; o++) if (this.p.colModel[o].index == c || this.p.colModel[o].name == c) {
                        i = o;
                        break
                    }
                    if (i != -1) {
                        ...
                        o && this.sortData("jqgh_" + this.p.id + "_" + c, i, h, b)
                    }
                }
            })
        },
        ...
        filterToolbar: function(c) {
            ...
            return this.each(function() {
                ...
                if (!this.ftoolbar) {
                    var i = function() {
                        ...
                        function() {
                            ...
                            case "select":
                                ...
                                if (j = a("#gs_" + a.jgrid.jqID(this.name), b.grid.hDiv).val()) {
                                    e[d] = j;
                                    g[d] = k;
                                    f++
                                } else try {
                    ...
                    o = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),
                    t;
                    a.each(b.p.colModel,
                    function() {
                        var e = this,
                        ...
                        case "select":
                            if (g = this.surl || d.dataUrl) a.ajax(a.extend({
                                ...
                                dataType: "html",
                                complete: function(l) {
                                    if (d.buildSelect !== undefined)(l = d.buildSelect(l)) && a(f).append(l);
                                    else a(f).append(l.responseText);
                            ...
                            a.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {}));
                                ...
                                var k;
                                if (e.searchoptions && e.searchoptions.value) k = e.searchoptions.value;
                                else if (e.editoptions && e.editoptions.value) k = e.editoptions.value;
                                if (k) {
                    ...
                    this.clearToolbar = function(e) {
                        ...
                        a.each(b.p.colModel,
                        function() {
                            j = this.searchoptions && this.searchoptions.defaultValue ? this.searchoptions.defaultValue: "";
                        ...
                        var l = false;
                        if (a.isFunction(c.beforeClear)) l = c.beforeClear.call(b);
                        l || e && a(b).jqGrid("setGridParam", {
                            search: k
                        }).trigger("reloadGrid", [{
                            page: 1
                        }]);
    ...
    a.extend(a.jgrid, {
        ...
        createModal: function(b, c, d, f, g, h, j) {
            ...
            var q = a("<a href='javascript:void(0)' class='ui-jqdialog-titlebar-close ui-corner-all'></a>").hover(function() {
            ...
            a("a.ui-jqdialog-titlebar-close", i).click(function() {
                var p = a("#" + b.themodal).data("onClose") || d.onClose,
                o = a("#" + b.themodal).data("gbox") || d.gbox;
                m.hideModal("#" + b.themodal, {
                    gb: o,
                    jqm: d.jqModal,
                    onClose: p
                });
        ...
        createEl: function(b, c, d, f, g) {
            ...
            case "button":
                ...
                /** 
                  * 解决谷歌下添加新增url资源添加参数失败问题
                  * 原因是input输入框在ie下输入内容后会自动添加value属性，而在谷歌中不会自动添加，导致前台获取不到value值
                  * add by jiajianhui--2014-09-03
                  */
                $(e).attr("value",$(e).val());
                $(e).bind("blur",function(){$(e).attr("value",$(e).val())});
    ...
    a.jgrid.extend({
            ...
            return this.each(function() {
                function b() {
                    ...
                    if (E) {
                        ...
                        a.isFunction(d.afterShowSearch) && d.afterShowSearch(a("#" + r))
                    }
                }
                function p() {
                    a(".add-rule", "#" + r).hide();
                    a(".delete-rule", "#" + r).hide();
                    a(".opsel", "#" + r).hide()
                }
                var w = this;
                if (w.grid) {
                    ...
                    y = w.p.postData[d.sFilter];
                    if (typeof y === "string") y = a.jgrid.parse(y);
                    d.recreateFilter === true && a("#" + G.themodal).remove();
                    if (a("#" + G.themodal).html() !== null) b();
                    else {
                        var k = a("<span><div id='" + r + "' class='searchFilter' style='overflow:auto'></div></span>").insertBefore("#gview_" + w.p.id);
                        if (a.isFunction(d.onInitializeSearch)) d.onInitializeSearch(a("#" + r));
                        var q = a.extend([], w.p.colModel),
                        t = "<a href='javascript:void(0)' id='" + r + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + d.Find + "</a>",
                        n = "<a href='javascript:void(0)' id='" + r + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + d.Reset + "</a>",
                        e = "",
                        v = "",
                        o,
                        g = false,
                        m = -1;
                        if (d.showQuery) e = "<a href='javascript:void(0)' id='" + r + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>";
                        if (d.columns.length) q = d.columns;
                        else a.each(q,
                        function(F, u) {
                            if (!u.label) u.label = w.p.colNames[F];
                            if (!g) {
                                var N = typeof u.search === "undefined" ? true: u.search,
                                B = u.hidden === true;
                                if (u.searchoptions && u.searchoptions.searchhidden === true && N || N && !B) {
                                    g = true;
                                    o = u.index || u.name;
                                    m = F
                                }
                        ...
                        if (!y && o || d.multipleSearch === false) {
                            var K = "eq";
                            if (m >= 0 && q[m].searchoptions && q[m].searchoptions.sopt) K = q[m].searchoptions.sopt[0];
                            else if (d.sopt && d.sopt.length) K = d.sopt[0];
                            y = {
                                groupOp: "AND",
                                rules: [{
                                    field: o,
                        ...
                        if (d.tmplNames && d.tmplNames.length) {
                            ...
                            a.each(d.tmplNames,
                            function(F, u) {
                                v += "<option value='" + F + "'>" + u + "</option>"
                            });
                            v += "</select>"
                        }
                        t = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + r + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:left'>" + n + v + "</td><td class='EditButton'>" + e + t + "</td></tr></tbody></table>";
                        a("#" + r).jqFilter({
                            columns: q,
                            filter: d.loadDefaults ? y: null,
                        ...
                        k.append(t);
                        g && d.tmplFilters && d.tmplFilters.length && a(".ui-template", k).bind("change",
                        function() {
                            var F = a(this).val();
                            F == "default" ? a("#" + r).jqFilter("addFilter", y) : a("#" + r).jqFilter("addFilter", d.tmplFilters[parseInt(F, 10)]);
                            return false
                        });
                        d.multipleSearch === false && p();
                        if (a.isFunction(d.onInitializeSearch)) d.onInitializeSearch(a("#" + r));
                        d.layer ? a.jgrid.createModal(G, k, d, "#gview_" + w.p.id, a("#gbox_" + w.p.id)[0], "#" + d.layer, {
                            position: "relative"
                        }) : a.jgrid.createModal(G, k, d, "#gview_" + w.p.id, a("#gbox_" + w.p.id)[0]);
                        e && a("#" + r + "_query").bind("click",
                        function() {
                            a(".queryresult", k).toggle();
                            return false
                        });
                        if (d.stringResult === undefined) d.stringResult = d.multipleSearch;
                        a("#" + r + "_search").bind("click",
                        function() {
                            var F = a("#" + r),
                            u = {},
                            N,
                            B = F.jqFilter("filterData");
                            if (d.errorcheck) {
                                F[0].hideError();
                            ...
                            if (d.stringResult) {
                                ...
                                u[d.sField] = B.rules[0].field;
                                u[d.sValue] = B.rules[0].data;
                                u[d.sOper] = B.rules[0].op;
                                u[d.sFilter] = ""
                            }
                            w.p.search = true;
                            a.extend(w.p.postData, u);
                            if (a.isFunction(d.onSearch)) d.onSearch();
                            a(w).trigger("reloadGrid", [{
                                page: 1
                            }]);
                            d.closeAfterSearch && a.jgrid.hideModal("#" + G.themodal, {
                                gb: "#gbox_" + w.p.id,
                                jqm: d.jqModal,
                                onClose: d.onClose
                            });
                        ...
                        a("#" + r + "_reset").bind("click",
                        function() {
                            var F = {},
                            u = a("#" + r);
                            w.p.search = false;
                            if (d.multipleSearch === false) F[d.sField] = F[d.sValue] = F[d.sOper] = "";
                            else F[d.sFilter] = "";
                            u[0].resetFilter();
                            g && a(".ui-template", k).val("default");
                            a.extend(w.p.postData, F);
        ...
        editGridRow: function(d, b) {
            ...
            return this.each(function() {
                function p() {
                    a(".FormElement", "#" + g).each(function() {
                        var f = a(".customelement", this);
                        if (f.length) {
                            var j = a(f[0]).attr("name");
                            a.each(e.p.colModel,
                            function() {
                                if (this.name === j && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        h[j] = this.editoptions.custom_value(a("#" + a.jgrid.jqID(j), "#" + g), "get");
                                        if (h[j] === undefined) throw "e1";
                                    } catch(s) {
                            ...
                            case "checkbox":
                                if (a(this).attr("checked")) h[this.name] = a(this).val();
                                else {
                            ...
                            case "select-one":
                                ...
                                Q[this.name] = a("option:selected", this).text();
                                break;
                            case "select-multiple":
                                h[this.name] = a(this).val();
                                h[this.name] = h[this.name] ? h[this.name].join(",") : "";
                                var x = [];
                                a("option:selected", this).each(function(s, I) {
                                    x[s] = a(I).text()
                                });
                                Q[this.name] = x.join(",");
                                break;
                ...
                function w(f, j, x, s) {
                    ...
                    aa = "",
                    S;
                    for (S = 1; S <= s; S++) aa += "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
                    if (f != "_empty") M = a(j).jqGrid("getInd", f);
                    a(j.p.colModel).each(function(U) {
                        I = this.name;
                        O = (D = this.editrules && this.editrules.edithidden === true ? false: this.hidden === true ? true: false) ? "style='display:none'": "";
                        if (I !== "cb" && I !== "subgrid" && this.editable === true && I !== "rn") {
                            if (M === false) z = "";
                            else if (I == j.p.ExpandColumn && j.p.treeGrid === true) z = a("td:eq(" + U + ")", j.rows[M]).text();
                            else {
                                try {
                                    z = a.unformat(a("td:eq(" + U + ")", j.rows[M]), {
                                        rowId: f,
                                        colModel: this
                                    },
                                    U)
                                } catch(fa) {
                                    z = this.edittype && this.edittype == "textarea" ? a("td:eq(" + U + ")", j.rows[M]).text() : a("td:eq(" + U + ")", j.rows[M]).html()
                                }
                            ...
                            this.formoptions || {}),
                            ea = parseInt(Z.rowpos, 10) || L + 1,
                            ga = parseInt((parseInt(Z.colpos, 10) || 1) * 2, 10);
                            if (f == "_empty" && Y.defaultValue) z = a.isFunction(Y.defaultValue) ? Y.defaultValue() : Y.defaultValue;
                            if (!this.edittype) this.edittype = "text";
                            if (e.p.autoencode) z = a.jgrid.htmlDecode(z);
                            H = a.jgrid.createEl(this.edittype, Y, z, false, a.extend({},
                            a.jgrid.ajaxOptions, j.p.ajaxSelectOptions || {}));
                            if (z === "" && this.edittype == "checkbox") z = a(H).attr("offval");
                            if (z === "" && this.edittype == "select") z = a("option:eq(0)", H).text();
                            if (c.checkOnSubmit || c.checkOnUpdate) c._savedData[I] = z;
                            a(H).addClass("FormElement");
                            if (this.edittype == "text" || this.edittype == "textarea") a(H).addClass("ui-widget-content ui-corner-all");
                            C = a(x).find("tr[rowpos=" + ea + "]");
                            if (Z.rowabove) {
                                Y = a("<tr><td class='contentinfo' colspan='" + s * 2 + "'>" + Z.rowcontent + "</td></tr>");
                                a(x).append(Y);
                                Y[0].rp = ea
                            }
                            if (C.length === 0) {
                                C = a("<tr " + O + " rowpos='" + ea + "'></tr>").addClass("FormData").attr("id", "tr_" + I);
                                a(C).append(aa);
                                a(x).append(C);
                                C[0].rp = ea
                            }
                            a("td:eq(" + (ga - 2) + ")", C[0]).html(typeof Z.label === "undefined" ? j.p.colNames[U] : Z.label);
                            a("td:eq(" + (ga - 1) + ")", C[0]).append(Z.elmprefix).append(H).append(Z.elmsuffix);
                            T[L] = U;
                            L++
                        }
                    });
                    if (L > 0) {
                        S = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (s * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + j.p.id + "_id' value='" + f + "'/></td></tr>");
                        S[0].rp = L + 999;
                        a(x).append(S);
                        if (c.checkOnSubmit || c.checkOnUpdate) c._savedData[j.p.id + "_id"] = f
                    }
                    return T
                }
                function r(f, j, x) {
                    ...
                    if (f == "_empty") {
                        a(H).each(function() {
                            ...
                            L = a.extend({},
                            this.editoptions || {});
                            if ((C = a("#" + a.jgrid.jqID(s), "#" + x)) && C.length && C[0] !== null) {
                                z = "";
                                if (L.defaultValue) {
                                    z = a.isFunction(L.defaultValue) ? L.defaultValue() : L.defaultValue;
                                ...
                                if (c.checkOnSubmit === true || c.checkOnUpdate) c._savedData[s] = z
                            }
                        });
                        a("#id_g", "#" + x).val(f)
                    } else {
                        var T = a(j).jqGrid("getInd", f, true);
                        if (T) {
                            a("td", T).each(function(M) {
                                s = H[M].name;
                                if (s !== "cb" && s !== "subgrid" && s !== "rn" && H[M].editable === true) {
                                    if (s == j.p.ExpandColumn && j.p.treeGrid === true) D = a(this).text();
                                    else try {
                                        D = a.unformat(a(this), {
                                            rowId: f,
                                            colModel: H[M]
                                        ...
                                        D = H[M].edittype == "textarea" ? a(this).text() : a(this).html()
                                    }
                                    if (e.p.autoencode) D = a.jgrid.htmlDecode(D);
                                    if (c.checkOnSubmit === true || c.checkOnUpdate) c._savedData[s] = D;
                                    s = a.jgrid.jqID(s);
                                    switch (H[M].edittype) {
                                    case "password":
                                    case "text":
                                    ...
                                    case "select":
                                        ...
                                        a("#" + s + " option", "#" + x).each(function() {
                                            this.selected = !H[M].editoptions.multiple && (S[0] == a.trim(a(this).text()) || S[0] == a.trim(a(this).val())) ? true: H[M].editoptions.multiple ? a.inArray(a.trim(a(this).text()), S) > -1 || a.inArray(a.trim(a(this).val()), S) > -1 ? true: false: false
                                        });
                                        break;
                                    case "checkbox":
                                        D += "";
                                        if (H[M].editoptions && H[M].editoptions.value) if (H[M].editoptions.value.split(":")[0] == D) {
                                    ...
                                    case "custom":
                                        try {
                                            if (H[M].editoptions && a.isFunction(H[M].editoptions.custom_value)) H[M].editoptions.custom_value(a("#" + s, "#" + x), "set", D);
                                            else throw "e1";
                                        } catch(U) {
                ...
                function E() {
                    ...
                    if (a.isFunction(c.beforeCheckValues)) {
                        var z = c.beforeCheckValues(h, a("#" + o), h[e.p.id + "_id"] == "_empty" ? s.addoper: s.editoper);
                        if (z && typeof z === "object") h = z
                    }
                    for (C in h) if (h.hasOwnProperty(C)) {
                        j = a.jgrid.checkValues(h[C], C, e);
                        if (j[0] === false) break
                    }
                    if (j[0]) {
                        if (a.isFunction(c.onclickSubmit)) x = c.onclickSubmit(c, h) || {};
                        if (a.isFunction(c.beforeSubmit)) j = c.beforeSubmit(h, a("#" + o))
                    }
                    if (j[0] && !c.processing) {
                        c.processing = true;
                        a("#sData", "#" + g + "_2").addClass("ui-state-active");
                        D = s.oper;
                        I = s.id;
                        h[D] = a.trim(h[e.p.id + "_id"]) == "_empty" ? s.addoper: s.editoper;
                        if (h[D] != s.addoper) h[I] = h[e.p.id + "_id"];
                        else if (h[I] === undefined) h[I] = h[e.p.id + "_id"];
                        delete h[e.p.id + "_id"];
                        h = a.extend(h, c.editData, x);
                        if (e.p.treeGrid === true) {
                            if (h[D] == s.addoper) {
                                L = a(e).jqGrid("getGridParam", "selrow");
                                h[e.p.treeGridModel == "adjacency" ? e.p.treeReader.parent_id_field: "parent_id"] = L
                            }
                            for (i in e.p.treeReader) {
                                x = e.p.treeReader[i];
                                if (h.hasOwnProperty(x)) h[D] == s.addoper && i === "parent_id_field" || delete h[x]
                            }
                        }
                        x = a.extend({
                            url: c.url ? c.url: a(e).jqGrid("getGridParam", "editurl"),
                            type: c.mtype,
                            data: a.isFunction(c.serializeEditData) ? c.serializeEditData(h) : h,
                            complete: function(O, H) {
                                if (H != "success") {
                                    j[0] = false;
                                    j[1] = a.isFunction(c.errorTextFormat) ? c.errorTextFormat(O) : H + " Status: '" + O.statusText + "'. Error code: " + O.status
                                } else if (a.isFunction(c.afterSubmit)) j = c.afterSubmit(O, h);
                                if (j[0] === false) {
                                    a("#FormError>td", "#" + g).html(j[1]);
                                    a("#FormError", "#" + g).show()
                                } else {
                                    a.each(e.p.colModel,
                                    function() {
                                        if (Q[this.name] && this.formatter && this.formatter == "select") try {
                                            delete Q[this.name]
                                        } catch(aa) {}
                                    });
                                    h = a.extend(h, Q);
                                    e.p.autoencode && a.each(h,
                                    function(aa, S) {
                                        h[aa] = a.jgrid.htmlDecode(S)
                                    });
                                    c.reloadAfterSubmit = c.reloadAfterSubmit && e.p.datatype != "local";
                                    if (h[D] == s.addoper) {
                                        j[2] || (j[2] = a.jgrid.randId());
                                        h[I] = j[2];
                                        if (c.closeAfterAdd) {
                                            if (c.reloadAfterSubmit) a(e).trigger("reloadGrid");
                                            else if (e.p.treeGrid === true) a(e).jqGrid("addChildNode", j[2], L, h);
                                            else {
                                                a(e).jqGrid("addRowData", j[2], h, b.addedrow);
                                                a(e).jqGrid("setSelection", j[2])
                                            }
                                            ...
                                            if (c.reloadAfterSubmit) a(e).trigger("reloadGrid");
                                            else e.p.treeGrid === true ? a(e).jqGrid("addChildNode", j[2], L, h) : a(e).jqGrid("addRowData", j[2], h, b.addedrow);
                                            r("_empty", e, o)
                                        } else if (c.reloadAfterSubmit) a(e).trigger("reloadGrid");
                                        else e.p.treeGrid === true ? a(e).jqGrid("addChildNode", j[2], L, h) : a(e).jqGrid("addRowData", j[2], h, b.addedrow)
                                    } else {
                                        if (c.reloadAfterSubmit) {
                                            a(e).trigger("reloadGrid");
                                            c.closeAfterEdit || setTimeout(function() {
                                                a(e).jqGrid("setSelection", h[I])
                                            },
                                            1E3)
                                        } else e.p.treeGrid === true ? a(e).jqGrid("setTreeRow", h[I], h) : a(e).jqGrid("setRowData", h[I], h);
                                        c.closeAfterEdit && a.jgrid.hideModal("#" + m.themodal, {
                                            gb: "#gbox_" + v,
                                            jqm: b.jqModal,
                                            onClose: c.onClose
                                        })
                                    ...
                                    if (c.checkOnSubmit || c.checkOnUpdate) {
                                        ...
                                        if (c._savedData[e.p.id + "_id"] != "_empty") for (var T in c._savedData) if (h[T]) c._savedData[T] = h[T]
                                    }
                                }
                                c.processing = false;
                                a("#sData", "#" + g + "_2").removeClass("ui-state-active");
                                try {
                        ...
                        if (!x.url && !c.useDataProxy) if (a.isFunction(e.p.dataProxy)) c.useDataProxy = true;
                        else {
                            j[0] = false;
                            j[1] += " " + a.jgrid.errors.nourl
                        }
                        if (j[0]) c.useDataProxy ? e.p.dataProxy.call(e, x, "set_" + e.p.id) : a.ajax(x)
                    }
                    if (j[0] === false) {
                        a("#FormError>td", "#" + g).html(j[1]);
                        a("#FormError", "#" + g).show()
                ...
                function y() {
                    a.each(e.p.colModel,
                    function(f, j) {
                        if (j.editoptions && j.editoptions.NullIfEmpty === true) if (h.hasOwnProperty(j.name) && h[j.name] == "") h[j.name] = "null"
                    })
                }
                function k() {
                    var f = true;
                ...
                function q() {
                    if (d !== "_empty" && typeof e.p.savedRow !== "undefined" && e.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow)) for (var f = 0; f < e.p.savedRow.length; f++) if (e.p.savedRow[f].id == d) {
                        a(e).jqGrid("restoreRow", d);
                        break
                    }
                }
                function t(f, j) {
                    f === 0 ? a("#pData", "#" + g + "_2").addClass("ui-state-disabled") : a("#pData", "#" + g + "_2").removeClass("ui-state-disabled");
                    f == j ? a("#nData", "#" + g + "_2").addClass("ui-state-disabled") : a("#nData", "#" + g + "_2").removeClass("ui-state-disabled")
                }
                function n() {
                    var f = a(e).jqGrid("getDataIDs"),
                    j = a("#id_g", "#" + g).val();
                    return [a.inArray(j, f), f]
                }
                var e = this;
                if (e.grid && d) {
                    var v = e.p.id,
                    ...
                    K = a.isFunction(c.beforeShowForm) ? c.beforeShowForm: false,
                    F = a.isFunction(c.afterShowForm) ? c.afterShowForm: false,
                    u = a.isFunction(c.beforeInitData) ? c.beforeInitData: false,
                    N = a.isFunction(c.onInitializeForm) ? c.onInitializeForm: false,
                    B = true,
                    l = 1,
                    A = 0,
                    h,
                    ...
                    var R = true;
                    if (b.checkOnUpdate && b.jqModal && !b.modal) R = false;
                    if (a("#" + m.themodal).html() !== null) {
                        ...
                        a("#FormError", "#" + g).hide();
                        if (c.topinfo) {
                            a(".topinfo", "#" + g + "_2").html(c.topinfo);
                            a(".tinfo", "#" + g + "_2").show()
                        } else a(".tinfo", "#" + g + "_2").hide();
                        if (c.bottominfo) {
                            a(".bottominfo", "#" + g + "_2").html(c.bottominfo);
                            a(".binfo", "#" + g + "_2").show()
                        } else a(".binfo", "#" + g + "_2").hide();
                        r(d, e, o);
                        d == "_empty" || !c.viewPagerButtons ? a("#pData, #nData", "#" + g + "_2").hide() : a("#pData, #nData", "#" + g + "_2").show();
                        ...
                        K && K(a("#" + o));
                        a("#" + m.themodal).data("onClose", c.onClose);
                        ...
                        J = a("<form name='FormPost' id='" + o + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + J + ";'></form>").data("disabled", false);
                        var W = a("<table id='" + g + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");
                        if (u) {
                            B = u(a("#" + o));
                            if (typeof B == "undefined") B = true
                        }
                        ...
                        a(e.p.colModel).each(function() {
                            ...
                            l = Math.max(l, f ? f.colpos || 0 : 0);
                            A = Math.max(A, f ? f.rowpos || 0 : 0)
                        });
                        a(J).append(W);
                        u = a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + l * 2 + "'></td></tr>");
                        u[0].rp = 0;
                        a(W).append(u);
                        u = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='" + l * 2 + "'>" + c.topinfo + "</td></tr>");
                        u[0].rp = 0;
                        a(W).append(u);
                        B = (u = e.p.direction == "rtl" ? true: false) ? "nData": "pData";
                        var X = u ? "pData": "nData";
                        w(d, e, W, l);
                        B = "<a href='javascript:void(0)' id='" + B + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
                        X = "<a href='javascript:void(0)' id='" + X + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";
                        ...
                        B = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + g + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (u ? X + B: B + X) + "</td><td class='EditButton'>" + ba + $ + "</td></tr>";
                        B += "<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + c.bottominfo + "</td></tr>";
                        B += "</tbody></table>";
                        if (A > 0) {
                            var ca = [];
                            a.each(a(W)[0].rows,
                            ...
                            ca.sort(function(f, j) {
                                if (f.rp > j.rp) return 1;
                                if (f.rp < j.rp) return - 1;
                                return 0
                            });
                            a.each(ca,
                        ...
                        J = a("<span></span>").append(J).append(B);
                        a.jgrid.createModal(m, J, b, "#gview_" + e.p.id, a("#gbox_" + e.p.id)[0]);
                        if (u) {
                            a("#pData, #nData", "#" + g + "_2").css("float", "right");
                            a(".EditButton", "#" + g + "_2").css("text-align", "left")
                        }
                        c.topinfo && a(".tinfo", "#" + g + "_2").show();
                        c.bottominfo && a(".binfo", "#" + g + "_2").show();
                        B = J = null;
                        a("#" + m.themodal).keydown(function(f) {
                            var j = f.target;
                            if (a("#" + o).data("disabled") === true) return false;
                            if (c.savekey[0] === true && f.which == c.savekey[1]) if (j.tagName != "TEXTAREA") {
                                a("#sData", "#" + g + "_2").trigger("click");
                                return false
                            }
                            if (f.which === 27) {
                                if (!k()) return false;
                            ...
                            if (c.navkeys[0] === true) {
                                if (a("#id_g", "#" + g).val() == "_empty") return true;
                                if (f.which == c.navkeys[1]) {
                                    a("#pData", "#" + g + "_2").trigger("click");
                                    return false
                                }
                                if (f.which == c.navkeys[2]) {
                        ...
                        if (b.saveicon[0] === true) a("#sData", "#" + g + "_2").addClass(b.saveicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + b.saveicon[2] + "'></span>");
                        if (b.closeicon[0] === true) a("#cData", "#" + g + "_2").addClass(b.closeicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + b.closeicon[2] + "'></span>");
                        if (c.checkOnSubmit || c.checkOnUpdate) {
                        ...
                        a("#sData", "#" + g + "_2").click(function() {
                            h = {};
                            Q = {};
                            a("#FormError", "#" + g).hide();
                            p();
                            y();
                            if (h[e.p.id + "_id"] == "_empty") E();
                        ...
                        a("#nData", "#" + g + "_2").click(function() {
                            ...
                            f[0] = parseInt(f[0], 10);
                            if (f[0] != -1 && f[1][f[0] + 1]) {
                                if (a.isFunction(b.onclickPgButtons)) b.onclickPgButtons("next", a("#" + o), f[1][f[0]]);
                                r(f[1][f[0] + 1], e, o);
                                a(e).jqGrid("setSelection", f[1][f[0] + 1]);
                                a.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons("next", a("#" + o), f[1][f[0] + 1]);
                                t(f[0] + 1, f[1].length - 1)
                            }
                            return false
                        });
                        a("#pData", "#" + g + "_2").click(function() {
                            ...
                            var f = n();
                            if (f[0] != -1 && f[1][f[0] - 1]) {
                                if (a.isFunction(b.onclickPgButtons)) b.onclickPgButtons("prev", a("#" + o), f[1][f[0]]);
                                r(f[1][f[0] - 1], e, o);
                                a(e).jqGrid("setSelection", f[1][f[0] - 1]);
                                a.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons("prev", a("#" + o), f[1][f[0] - 1]);
                                t(f[0] - 1, f[1].length - 1)
                            }
                            return false
                        })
        ...
        viewGridRow: function(d, b) {
            ...
            return this.each(function() {
                ...
                function w(l, A, h, Q) {
                    for (var P, V, R, J = 0,
                    W, X, ba = [], $ = false, ca = "<td class='CaptionTD form-view-label ui-widget-content' width='" + b.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", da = "", f = ["integer", "number", "currency"], j = 0, x = 0, s, I, D, C = 1; C <= Q; C++) da += C == 1 ? ca: "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                    a(A.p.colModel).each(function() {
                        V = this.editrules && this.editrules.edithidden === true ? false: this.hidden === true ? true: false;
                        if (!V && this.align === "right") if (this.formatter && a.inArray(this.formatter, f) !== -1) j = Math.max(j, parseInt(this.width, 10));
                        else x = Math.max(x, parseInt(this.width, 10))
                    });
                    s = j !== 0 ? j: x !== 0 ? x: 0;
                    $ = a(A).jqGrid("getInd", l);
                    a(A.p.colModel).each(function(L) {
                        P = this.name;
                        I = false;
                        ...
                        if (P !== "cb" && P !== "subgrid" && P !== "rn" && D) {
                            W = $ === false ? "": P == A.p.ExpandColumn && A.p.treeGrid === true ? a("td:eq(" + L + ")", A.rows[$]).text() : a("td:eq(" + L + ")", A.rows[$]).html();
                            I = this.align === "right" && s !== 0 ? true: false;
                            a.extend({},
                            this.editoptions || {},
                            {
                                id: P,
                            ...
                            this.formoptions || {}),
                            O = parseInt(z.rowpos, 10) || J + 1,
                            H = parseInt((parseInt(z.colpos, 10) || 1) * 2, 10);
                            if (z.rowabove) {
                                var T = a("<tr><td class='contentinfo' colspan='" + Q * 2 + "'>" + z.rowcontent + "</td></tr>");
                                a(h).append(T);
                                T[0].rp = O
                            }
                            R = a(h).find("tr[rowpos=" + O + "]");
                            if (R.length === 0) {
                                R = a("<tr " + X + " rowpos='" + O + "'></tr>").addClass("FormData").attr("id", "trv_" + P);
                                a(R).append(da);
                                a(h).append(R);
                                R[0].rp = O
                            }
                            a("td:eq(" + (H - 2) + ")", R[0]).html("<b>" + (typeof z.label === "undefined" ? A.p.colNames[L] : z.label) + "</b>");
                            a("td:eq(" + (H - 1) + ")", R[0]).append("<span>" + W + "</span>").attr("id", "v_" + P);
                            I && a("td:eq(" + (H - 1) + ") span", R[0]).css({
                                "text-align": "right",
                                width: s + "px"
                            });
                            ba[J] = L;
                    ...
                    if (J > 0) {
                        l = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (Q * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + l + "'/></td></tr>");
                        l[0].rp = J + 99;
                        a(h).append(l)
                    }
                    return ba
                ...
                function r(l, A) {
                    var h, Q, P = 0,
                    V, R;
                    if (R = a(A).jqGrid("getInd", l, true)) {
                        a("td", R).each(function(J) {
                            h = A.p.colModel[J].name;
                            Q = A.p.colModel[J].editrules && A.p.colModel[J].editrules.edithidden === true ? false: A.p.colModel[J].hidden === true ? true: false;
                            if (h !== "cb" && h !== "subgrid" && h !== "rn") {
                                V = h == A.p.ExpandColumn && A.p.treeGrid === true ? a(this).text() : a(this).html();
                                a.extend({},
                                A.p.colModel[J].editoptions || {});
                                h = a.jgrid.jqID("v_" + h);
                                a("#" + h + " span", "#" + t).html(V);
                                Q && a("#" + h, "#" + t).parents("tr:first").hide();
                                P++
                            }
                        });
                        P > 0 && a("#id_g", "#" + t).val(l)
                ...
                function E(l, A) {
                    l === 0 ? a("#pData", "#" + t + "_2").addClass("ui-state-disabled") : a("#pData", "#" + t + "_2").removeClass("ui-state-disabled");
                    l == A ? a("#nData", "#" + t + "_2").addClass("ui-state-disabled") : a("#nData", "#" + t + "_2").removeClass("ui-state-disabled")
                }
                function G() {
                    var l = a(y).jqGrid("getDataIDs"),
                    A = a("#id_g", "#" + t).val();
                    return [a.inArray(A, l), l]
                }
                var y = this;
                if (y.grid && d) {
                    if (!b.imgpath) b.imgpath = y.p.imgpath;
                    var k = y.p.id,
                    q = "ViewGrid_" + k,
                    t = "ViewTbl_" + k,
                    n = {
                    ...
                    e = a.isFunction(b.beforeInitData) ? b.beforeInitData: false,
                    v = true,
                    o = 1,
                    g = 0;
                    if (a("#" + n.themodal).html() !== null) {
                        ...
                        if (v === false) return;
                        a(".ui-jqdialog-title", "#" + n.modalhead).html(b.caption);
                        a("#FormError", "#" + t).hide();
                        r(d, y);
                        a.isFunction(b.beforeShowForm) && b.beforeShowForm(a("#" + q));
                        ...
                        m = a("<form name='FormPost' id='" + q + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + m + ";'></form>");
                        var K = a("<table id='" + t + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                        if (e) {
                            v = e(a("#" + q));
                            if (typeof v == "undefined") v = true
                        }
                        ...
                        a(y.p.colModel).each(function() {
                            ...
                            g = Math.max(g, l ? l.rowpos || 0 : 0)
                        });
                        a(m).append(K);
                        w(d, y, K, o);
                        e = y.p.direction == "rtl" ? true: false;
                        v = "<a href='javascript:void(0)' id='" + (e ? "nData": "pData") + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
                        var F = "<a href='javascript:void(0)' id='" + (e ? "pData": "nData") + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",
                        ...
                        m = a("<span></span>").append(m).append("<table border='0' class='EditTable' id='" + t + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + b.labelswidth + "'>" + (e ? F + v: v + F) + "</td><td class='EditButton'>" + u + "</td></tr></tbody></table>");
                        a.jgrid.createModal(n, m, b, "#gview_" + y.p.id, a("#gview_" + y.p.id)[0]);
                        if (e) {
                        ...
                        m = null;
                        a("#" + n.themodal).keydown(function(l) {
                            if (l.which === 27) {
                                B && a.jgrid.hideModal(this, {
                                    gb: b.gbox,
                                    jqm: b.jqModal,
                                    onClose: b.onClose
                                });
                        ...
                        a("#nData", "#" + t + "_2").click(function() {
                            ...
                            l[0] = parseInt(l[0], 10);
                            if (l[0] != -1 && l[1][l[0] + 1]) {
                                if (a.isFunction(b.onclickPgButtons)) b.onclickPgButtons("next", a("#" + q), l[1][l[0]]);
                                r(l[1][l[0] + 1], y);
                                a(y).jqGrid("setSelection", l[1][l[0] + 1]);
                                a.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons("next", a("#" + q), l[1][l[0] + 1]);
                                E(l[0] + 1, l[1].length - 1)
                            }
                            p();
                            return false
                        });
                        a("#pData", "#" + t + "_2").click(function() {
                            ...
                            var l = G();
                            if (l[0] != -1 && l[1][l[0] - 1]) {
                                if (a.isFunction(b.onclickPgButtons)) b.onclickPgButtons("prev", a("#" + q), l[1][l[0]]);
                                r(l[1][l[0] - 1], y);
                                a(y).jqGrid("setSelection", l[1][l[0] - 1]);
                                a.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons("prev", a("#" + q), l[1][l[0] - 1]);
                                E(l[0] - 1, l[1].length - 1)
                            }
                            p();
                            return false
        ...
        delGridRow: function(d, b) {
            ...
            return this.each(function() {
                var p = this;
                if (p.grid) if (d) {
                    var w = a.isFunction(b.beforeShowForm),
                    r = a.isFunction(b.afterShowForm),
                    E = a.isFunction(b.beforeInitData) ? b.beforeInitData: false,
                    G = p.p.id,
                    y = {},
                    k = true,
                    ...
                    if (a("#" + o.themodal).html() !== null) {
                        ...
                        if (k === false) return;
                        a("#DelData>td", "#" + q).text(d);
                        a("#DelError", "#" + q).hide();
                        if (c.processing === true) {
                            c.processing = false;
                            a("#dData", "#" + q).removeClass("ui-state-active")
                        }
                        w && b.beforeShowForm(a("#" + q));
                        ...
                        var g = isNaN(b.dataheight) ? b.dataheight: b.dataheight + "px";
                        g = "<div id='" + q + "' class='formdata' style='width:100%;overflow:auto;position:relative;height:" + g + ";'>";
                        g += "<table class='DelTable'><tbody>";
                        g += "<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>";
                        g += "<tr id='DelData' style='display:none'><td >" + d + "</td></tr>";
                        g += '<tr><td class="delmsg" style="white-space:pre;">' + b.msg + "</td></tr><tr><td >&#160;</td></tr>";
                        g += "</tbody></table></div>";
                        g += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + q + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr></tr><tr><td class='DelButton EditButton'>" + ("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>") + "&#160;" + ("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>") + "</td></tr></tbody></table>";
                        b.gbox = "#gbox_" + G;
                        a.jgrid.createModal(o, g, b, "#gview_" + p.p.id, a("#gview_" + p.p.id)[0]);
                        if (E) {
                            k = E(a("#" + q));
                            if (typeof k == "undefined") k = true
                        }
                        if (k === false) return;
                        a(".fm-button", "#" + q + "_2").hover(function() {
                            a(this).addClass("ui-state-hover")
                        },
                        function() {
                            a(this).removeClass("ui-state-hover")
                        ...
                        if (b.delicon[0] === true) a("#dData", "#" + q + "_2").addClass(b.delicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + b.delicon[2] + "'></span>");
                        if (b.cancelicon[0] === true) a("#eData", "#" + q + "_2").addClass(b.cancelicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + b.cancelicon[2] + "'></span>");
                        a("#dData", "#" + q + "_2").click(function() {
                            var m = [true, ""];
                            y = {};
                            var K = a("#DelData>td", "#" + q).text();
                            if (a.isFunction(b.onclickSubmit)) y = b.onclickSubmit(c, K) || {};
                            if (a.isFunction(b.beforeSubmit)) m = b.beforeSubmit(K);
                            if (m[0] && !c.processing) {
                                c.processing = true;
                                ...
                                var F = a.extend({
                                    ...
                                    type: b.mtype,
                                    data: a.isFunction(b.serializeDelData) ? b.serializeDelData(t) : t,
                                    complete: function(u, N) {
                                        if (N != "success") {
                                            m[0] = false;
                                            m[1] = a.isFunction(c.errorTextFormat) ? c.errorTextFormat(u) : N + " Status: '" + u.statusText + "'. Error code: " + u.status
                                        } else if (a.isFunction(c.afterSubmit)) m = c.afterSubmit(u, t);
                                        if (m[0] === false) {
                                            a("#DelError>td", "#" + q).html(m[1]);
                                            a("#DelError", "#" + q).show()
                                        } else {
                                            if (c.reloadAfterSubmit && p.p.datatype != "local") a(p).trigger("reloadGrid");
                                                ...
                                                if (p.p.treeGrid === true) try {
                                                    a(p).jqGrid("delTreeNode", B[0])
                                                } catch(l) {} else for (var A = 0; A < B.length; A++) a(p).jqGrid("delRowData", B[A]);
                                                p.p.selrow = null;
                                                p.p.selarrrow = []
                                            }
                                        ...
                                        c.processing = false;
                                        a("#dData", "#" + q + "_2").removeClass("ui-state-active");
                                ...
                                if (!F.url && !c.useDataProxy) if (a.isFunction(p.p.dataProxy)) c.useDataProxy = true;
                                else {
                                    m[0] = false;
                                    m[1] += " " + a.jgrid.errors.nourl
                                }
                                if (m[0]) c.useDataProxy ? p.p.dataProxy.call(p, F, "del_" + p.p.id) : a.ajax(F)
                            }
                            if (m[0] === false) {
                                a("#DelError>td", "#" + q).html(m[1]);
                                a("#DelError", "#" + q).show()
        ...
        navGrid: function(d, b, p, w, r, E, G) {
            b = a.extend({
                edit: true,
                ...
                if (!this.nav) {
                    ...
                    if (! (!k.grid || typeof d != "string")) {
                        if (a("#" + y.themodal).html() === null) {
                            ...
                            a.jgrid.createModal(y, "<div>" + b.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                                gbox: "#gbox_" + k.p.id,
                                jqModal: true,
                                drag: true,
                                resize: true,
                        ...
                        q = 1;
                        if (b.cloneToTop && k.p.toppager) q = 2;
                        for (t = 0; t < q; t++) {
                            var e = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                            v,
                            o;
                            if (t === 0) {
                                v = d;
                            ...
                            k.p.direction == "rtl" && a(e).attr("dir", "rtl").css("float", "right");
                            if (b.add) {
                                w = w || {};
                                n = a("<td class='ui-pg-button ui-corner-all'></td>");
                                a(n).append("<div class='ui-pg-div'><span class='ui-icon " + b.addicon + "'></span>" + b.addtext + "</div>");
                                a("tr", e).append(n);
                                a(n, e).attr({
                                    title: b.addtitle || "",
                                    id: w.id || "add_" + o
                                }).click(function() {
                                    a(this).hasClass("ui-state-disabled") || (a.isFunction(b.addfunc) ? b.addfunc() : a(k).jqGrid("editGridRow", "new", w));
                                    return false
                                }).hover(function() {
                            ...
                            if (b.edit) {
                                n = a("<td class='ui-pg-button ui-corner-all'></td>");
                                p = p || {};
                                a(n).append("<div class='ui-pg-div'><span class='ui-icon " + b.editicon + "'></span>" + b.edittext + "</div>");
                                a("tr", e).append(n);
                                a(n, e).attr({
                                    title: b.edittitle || "",
                                    id: p.id || "edit_" + o
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var g = k.p.selrow;
                                        if (g) a.isFunction(b.editfunc) ? b.editfunc(g) : a(k).jqGrid("editGridRow", g, p);
                                        else {
                            ...
                            if (b.view) {
                                n = a("<td class='ui-pg-button ui-corner-all'></td>");
                                G = G || {};
                                a(n).append("<div class='ui-pg-div'><span class='ui-icon " + b.viewicon + "'></span>" + b.viewtext + "</div>");
                                a("tr", e).append(n);
                                a(n, e).attr({
                                    title: b.viewtitle || "",
                                    id: G.id || "view_" + o
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var g = k.p.selrow;
                                        if (g) a.isFunction(b.viewfunc) ? b.viewfunc(g) : a(k).jqGrid("viewGridRow", g, G);
                                        else {
                                            a.jgrid.viewModal("#" + y.themodal, {
                                                gbox: "#gbox_" + k.p.id,
                                                jqm: true
                            ...
                            if (b.del) {
                                n = a("<td class='ui-pg-button ui-corner-all'></td>");
                                r = r || {};
                                a(n).append("<div class='ui-pg-div'><span class='ui-icon " + b.delicon + "'></span>" + b.deltext + "</div>");
                                a("tr", e).append(n);
                                a(n, e).attr({
                                    title: b.deltitle || "",
                                    id: r.id || "del_" + o
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (g)"function" == typeof b.delfunc ? b.delfunc(g) : a(k).jqGrid("delGridRow", g, r);
                                        else {
                                            a.jgrid.viewModal("#" + y.themodal, {
                                                gbox: "#gbox_" + k.p.id,
                                                jqm: true
                            ...
                            if (b.search) {
                                n = a("<td class='ui-pg-button ui-corner-all'></td>");
                                E = E || {};
                                a(n).append("<div class='ui-pg-div'><span class='ui-icon " + b.searchicon + "'></span>" + b.searchtext + "</div>");
                                a("tr", e).append(n);
                                a(n, e).attr({
                                    title: b.searchtitle || "",
                                    id: E.id || "search_" + o
                                }).click(function() {
                                    a(this).hasClass("ui-state-disabled") || a(k).jqGrid("searchGrid", E);
                                    return false
                                }).hover(function() {
                                    a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                                },
                                ...
                                E.showOnLoad && E.showOnLoad === true && a(n, e).click();
                                n = null
                            }
                            if (b.refresh) {
                                n = a("<td class='ui-pg-button ui-corner-all'></td>");
                                a(n).append("<div class='ui-pg-div'><span class='ui-icon " + b.refreshicon + "'></span>" + b.refreshtext + "</div>");
                                a("tr", e).append(n);
                                a(n, e).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        try {
                                            ...
                                            a("#fbox_" + g).jqFilter("resetFilter");
                            ...
                            n = a(e).clone().appendTo("#testpg2").width();
                            a("#testpg2").remove();
                            a(v + "_" + b.position, v).append(e);
                            if (k.p._nvtd) {
                                if (n > k.p._nvtd[0]) {
                                    a(v + "_" + b.position, v).width(n);
                                    k.p._nvtd[0] = n
                                }
                                k.p._nvtd[1] = n
                            }
        ...
        navButtonAdd: function(d, b) {
            ...
            return this.each(function() {
                if (this.grid) {
                    if (d.indexOf("#") !== 0) d = "#" + d;
                    var p = a(".navtable", d)[0],
                    w = this;
                    if (p) if (! (b.id && a("#" + b.id, p).html() !== null)) {
                        var r = a("<td></td>");
                        b.buttonicon.toString().toUpperCase() == "NONE" ? a(r).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>" + b.caption + "</div>") : a(r).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon " + b.buttonicon + "'></span>" + b.caption + "</div>");
                        b.id && a(r).attr("id", b.id);
                        if (b.position == "first") p.rows[0].cells.length === 0 ? a("tr", p).append(r) : a("tr td:eq(0)", p).before(r);
                        else a("tr", p).append(r);
                        a(r, p).attr("title", b.title || "").click(function(E) {
                            a(this).hasClass("ui-state-disabled") || a.isFunction(b.onClickButton) && b.onClickButton.call(w, E);
                            return false
                        }).hover(function() {
                            a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                        },
        ...
        navSeparatorAdd: function(d, b) {
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    var p = a(".navtable", d)[0];
                    if (p) {
                        var w = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='" + b.sepclass + "'></span>" + b.sepcontent + "</td>";
                        a("tr", p).append(w)
                    }
                }
            })
        ...
        GridToForm: function(d, b) {
            return this.each(function() {
                if (this.grid) {
                    var p = a(this).jqGrid("getRowData", d);
                    if (p) for (var w in p) a("[name=" + a.jgrid.jqID(w) + "]", b).is("input:radio") || a("[name=" + a.jgrid.jqID(w) + "]", b).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(w) + "]", b).each(function() {
                        a(this).val() == p[w] ? a(this).attr("checked", "checked") : a(this).attr("checked", "")
                    }) : a("[name=" + a.jgrid.jqID(w) + "]", b).val(p[w])
                }
            })
        },
        FormToGrid: function(d, b, p, w) {
            return this.each(function() {
                if (this.grid) {
                    p || (p = "set");
                    w || (w = "first");
                    var r = a(b).serializeArray(),
                    E = {};
                    a.each(r,
                    function(G, y) {
                        E[y.name] = y.value
                    });
                    if (p == "add") a(this).jqGrid("addRowData", d, E, w);
                    else p == "set" && a(this).jqGrid("setRowData", d, E)
                }
            })
        }
    })
    ...
    c.fn.jqFilter = function(k) {
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                i, y = /msie/i.test(navigator.userAgent) && !window.opera;
                ...
                if (x) {
                    ...
                    this.p.showQuery && c(this).append("<table class='queryresult ui-widget ui-widget-content' style='display:block;max-width:440px;border:0px none;'><tbody><tr><td class='query'></td></tr></tbody></table>");
                    var z = function(d, f) {
                        var a = [true, ""];
                        if (c.isFunction(f.searchrules)) a = f.searchrules(d, f);
                        else if (c.jgrid && c.jgrid.checkValues) try {
                            a = c.jgrid.checkValues(d, -1, null, f.searchrules, f.label)
                        } catch(b) {}
                    ...
                    this.createTableForGroup = function(d, f) {
                        var a = this,
                        b, e = c("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>");
                        f === null && c(e).append("<tr class='error' style='display:none;'><th colspan='5' class='ui-state-error' align='left'></th></tr>");
                        var g = c("<tr></tr>");
                        c(e).append(g);
                        var j = c("<th colspan='5' align='left'></th>");
                        g.append(j);
                        ...
                        for (b = 0; b < o.groupOps.length; b++) {
                            l = d.groupOp === a.p.groupOps[b] ? " selected='selected'": "";
                            g += "<option value='" + a.p.groupOps[b] + "'" + l + ">" + a.p.groupOps[b] + "</option>"
                        }
                        h.append(g).bind("change",
                        function() {
                            d.groupOp = c(h).val();
                            a.onchange()
                        });
                        ...
                        if (this.p.groupButton) {
                            g = c("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>");
                            g.bind("click",
                            function() {
                                if (d.groups === undefined) d.groups = [];
                                d.groups.push({
                                    groupOp: o.groupOps[0],
                                    rules: [],
                                    groups: []
                                });
                                a.reDraw();
                        ...
                        j.append(g);
                        g = c("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>");
                        var m;
                        g.bind("click",
                        function() {
                        ...
                        if (f !== null) {
                            ...
                            g.bind("click",
                            function() {
                                for (b = 0; b < f.groups.length; b++) if (f.groups[b] === d) {
                                    f.groups.splice(b, 1);
                                    break
                                }
                                a.reDraw();
                        ...
                        if (d.groups !== undefined) for (b = 0; b < d.groups.length; b++) {
                            j = c("<tr></tr>");
                            e.append(j);
                            g = c("<td class='first'></td>");
                            j.append(g);
                            g = c("<td colspan='4'></td>");
                            g.append(this.createTableForGroup(d.groups[b], d));
                            j.append(g)
                        }
                        if (d.groupOp === undefined) d.groupOp = a.p.groupOps[0];
                    ...
                    this.createTableRowForRule = function(d, f) {
                            ...
                            if (h) {
                                ...
                                for (e = 0; e < g.length; e++) {
                                    ...
                                    if (p !== -1) {
                                        ...
                                        A += "<option value='" + a.p.ops[p].name + "'" + v + ">" + a.p.ops[p].description + "</option>"
                                    }
                                }
                                c(".selectopts", j).empty().append(A);
                                c(".data", j).empty().append(r);
                                c(".input-elm", j).bind("change",
                                function() {
                                    d.data = c(this).val();
                                    a.onchange()
                                });
                        ...
                        var u = c("<select class='selectopts'></select>");
                        l.append(u);
                        u.bind("change",
                        function() {
                            d.op = c(u).val();
                            j = c(this).parents("tr:first");
                            var r = c(".input-elm", j)[0];
                            if (d.op === "nu" || d.op === "nn") {
                                d.data = "";
                                r.value = "";
                        ...
                        n.bind("click",
                        function() {
                            for (e = 0; e < f.rules.length; e++) if (f.rules[e] === d) {
                                f.rules.splice(e, 1);
                                break
                            }
                            a.reDraw();
                    ...
                    this.getStringForGroup = function(d) {
                        ...
                        if (d.groups !== undefined) for (a = 0; a < d.groups.length; a++) {
                            if (f.length > 1) f += " " + d.groupOp + " ";
                            try {
                                f += this.getStringForGroup(d.groups[a])
                            } catch(b) {
                                alert(b)
                            }
                        }
                        if (d.rules !== undefined) try {
                            for (a = 0; a < d.rules.length; a++) {
                                if (f.length > 1) f += " " + d.groupOp + " ";
                                f += this.getStringForRule(d.rules[a])
                            }
                        } catch(e) {
                            alert(e)
                        }
                    ...
                    this.getStringForRule = function(d) {
                        ...
                        return c.inArray(e.searchtype, ["int", "integer", "float", "number", "currency"]) !== -1 || a === "nn" || a === "nu" ? d.field + " " + f + " " + b: d.field + " " + f + ' "' + b + '"'
                    };
    ...
    a.jgrid.extend({
        editRow: function(f, x, m, r, t, y, u, k, s) {
            var g = {
                keys: x || false,
                oneditfunc: m || null,
                successfunc: r || null,
                url: t || null,
                extraparam: y || {},
                aftersavefunc: u || null,
                errorfunc: k || null,
                afterrestorefunc: s || null,
                restoreAfterErorr: true
            },
            o = a.makeArray(arguments).slice(1),
            b;
            b = o[0] && typeof o[0] == "object" && !a.isFunction(o[0]) ? a.extend(g, o[0]) : g;
            return this.each(function() {
                var d = this,
                c, j, v = 0,
                q = null,
                ...
                l, e;
                if (d.grid) {
                    l = a(d).jqGrid("getInd", f, true);
                    if (l !== false) if ((a(l).attr("editable") || "0") == "0" && !a(l).hasClass("not-editable-row")) {
                        e = d.p.colModel;
                        a("td", l).each(function(h) {
                            c = e[h].name;
                            var A = d.p.treeGrid === true && c == d.p.ExpandColumn;
                            if (A) j = a("span:first", this).html();
                            else try {
                                j = a.unformat(this, {
                                    rowId: f,
                                    colModel: e[h]
                                ...
                                j = e[h].edittype && e[h].edittype == "textarea" ? a(this).text() : a(this).html()
                            }
                            if (c != "cb" && c != "subgrid" && c != "rn") {
                                if (d.p.autoencode) j = a.jgrid.htmlDecode(j);
                                p[c] = j;
                                if (e[h].editable === true) {
                                    if (q === null) q = h;
                                    ...
                                    if (!e[h].edittype) e[h].edittype = "text";
                                    if (j == "&nbsp;" || j == "&#160;" || j.length == 1 && j.charCodeAt(0) == 160) j = "";
                                    i = a.jgrid.createEl(e[h].edittype, i, j, true, a.extend({},
                                    a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {}));
                                    a(i).addClass("editable");
                                    A ? a("span:first", this).append(i) : a(this).append(i);
                                    e[h].edittype == "select" && e[h].editoptions.multiple === true && a.browser.msie && a(i).width(a(i).width());
                                    v++
                                }
                            }
                        });
                        if (v > 0) {
                            ...
                            d.p.savedRow.push(p);
                            a(l).attr("editable", "1");
                            a("td:eq(" + q + ") input", l).focus();
                            b.keys === true && a(l).bind("keydown",
                            function(h) {
                                h.keyCode === 27 && a(d).jqGrid("restoreRow", f, s);
                                if (h.keyCode === 13) {
                                    if (h.target.tagName == "TEXTAREA") return true;
                                    a(d).jqGrid("saveRow", f, b);
                                    return false
                                }
                                h.stopPropagation()
                            });
                            a.isFunction(b.oneditfunc) && b.oneditfunc.call(d, f)
                        }
                    }
                }
            })
        ...
        saveRow: function(f, x, m, r, t, y, u) {
            var k = {
                ...
                url: m || null,
                extraparam: r || {},
                aftersavefunc: t || null,
                errorfunc: y || null,
                afterrestorefunc: u || null,
                restoreAfterErorr: true
            },
            s = a.makeArray(arguments).slice(1),
            g;
            g = s[0] && typeof s[0] == "object" && !a.isFunction(s[0]) ? a.extend(k, s[0]) : k;
            var o = false,
            b = this[0],
            d,
            c = {},
            ...
            l;
            if (!b.grid) return o;
            l = a(b).jqGrid("getInd", f, true);
            if (l === false) return o;
            k = a(l).attr("editable");
            g.url = g.url ? g.url: b.p.editurl;
            if (k === "1") {
                var e;
                a("td", l).each(function(n) {
                    e = b.p.colModel[n];
                    d = e.name;
                    if (d != "cb" && d != "subgrid" && e.editable === true && d != "rn" && !a(this).hasClass("not-editable-cell")) {
                        switch (e.edittype) {
                        case "checkbox":
                            var i = ["Yes", "No"];
                            if (e.editoptions) i = e.editoptions.value.split(":");
                        ...
                        case "select":
                            if (e.editoptions.multiple) {
                                ...
                                j[d] = a("select>option:selected", this).text()
                            }
                            if (e.formatter && e.formatter == "select") j = {};
                            break;
                        case "custom":
                            try {
                                if (e.editoptions && a.isFunction(e.editoptions.custom_value)) {
                                    c[d] = e.editoptions.custom_value.call(b, a(".customelement", this), "get");
                        ...
                        if (b.p.autoencode) c[d] = a.jgrid.htmlEncode(c[d]);
                        if (g.url !== "clientArray" && e.editoptions && e.editoptions.NullIfEmpty === true) if (c[d] == "") v[d] = "null"
                    }
                });
                if (p[0] === false) {
                    try {
                        var h = a.jgrid.findPos(a("#" + a.jgrid.jqID(f), b.grid.bDiv)[0]);
                ...
                if (c) {
                    ...
                    c = a.extend({},
                    c, b.p.inlineData, g.extraparam)
                }
                if (g.url == "clientArray") {
                    c = a.extend({},
                    c, j);
                    b.p.autoencode && a.each(c,
                    function(n, i) {
                        c[n] = a.jgrid.htmlDecode(i)
                    });
                    h = a(b).jqGrid("setRowData", f, c);
                    a(l).attr("editable", "0");
                    for (k = 0; k < b.p.savedRow.length; k++) if (b.p.savedRow[k].id == f) {
                        q = k;
                        break
                    }
                    q >= 0 && b.p.savedRow.splice(q, 1);
                    a.isFunction(g.aftersavefunc) && g.aftersavefunc.call(b, f, h);
                    o = true
                } else {
                    a("#lui_" + b.p.id).show();
                    v = a.extend({},
                    ...
                    a.ajax(a.extend({
                        url: g.url,
                        data: a.isFunction(b.p.serializeRowData) ? b.p.serializeRowData.call(b, v) : v,
                        type: "POST",
                        async: false,
                        complete: function(n, i) {
                            a("#lui_" + b.p.id).hide();
                            if (i === "success") if ((a.isFunction(g.successfunc) ? g.successfunc.call(b, n) : true) === true) {
                                b.p.autoencode && a.each(c,
                                function(z, B) {
                                ...
                                c = a.extend({},
                                c, j);
                                a(b).jqGrid("setRowData", f, c);
                                a(l).attr("editable", "0");
                                for (var w = 0; w < b.p.savedRow.length; w++) if (b.p.savedRow[w].id == f) {
                                    q = w;
                                    break
                                }
                                q >= 0 && b.p.savedRow.splice(q, 1);
                                a.isFunction(g.aftersavefunc) && g.aftersavefunc.call(b, f, n);
                                o = true
                            } else {
                                a.isFunction(g.errorfunc) && g.errorfunc.call(b, f, n, i);
                                g.restoreAfterError === true && a(b).jqGrid("restoreRow", f, g.afterrestorefunc)
                            }
                        },
                        error: function(n, i) {
                            a("#lui_" + b.p.id).hide();
                            if (a.isFunction(g.errorfunc)) g.errorfunc.call(b, f, n, i);
                            else try {
                                jQuery.jgrid.info_dialog(jQuery.jgrid.errors.errcap, '<div class="ui-state-error">' + n.responseText + "</div>", jQuery.jgrid.edit.bClose, {
                                    buttonalign: "right"
                                })
                            } catch(w) {
        ...
        restoreRow: function(f, x) {
            return this.each(function() {
                ...
                r, t, y = {};
                if (m.grid) {
                    t = a(m).jqGrid("getInd", f, true);
                    if (t !== false) {
                        for (var u = 0; u < m.p.savedRow.length; u++) if (m.p.savedRow[u].id == f) {
                            r = u;
                            break
                        }
                        if (r >= 0) {
                            ...
                            a.each(m.p.colModel,
                            function() {
                                if (this.editable === true && this.name in m.p.savedRow[r] && !a(this).hasClass("not-editable-cell")) y[this.name] = m.p.savedRow[r][this.name]
                            });
                            a(m).jqGrid("setRowData", f, y);
                            a(t).attr("editable", "0").unbind("keydown");
                            m.p.savedRow.splice(r, 1)
                        }
                ...
                if (! (!a.grid || a.p.cellEdit !== true)) {
                    ...
                    if (c !== null) {
                        ...
                        case "checkbox":
                            ...
                            g = e = b("#" + d + "_" + j, a.rows[d]).attr("checked") ? l[0] : l[1];
                            break;
                        case "password":
                        case "text":
                        case "textarea":
    ...
    b.jgrid.extend({
        ...
        addSubGridCell: function(f, d) {
            ...
            return '<td role="grid" aria-describedby="' + s + '_subgrid" class="ui-sgcollapsed sgcollapsed" ' + a + "><a href='javascript:void(0);'><span class='ui-icon " + n + "'></span></a></td>"
        },
        addSubGrid: function(f, d) {
            return this.each(function() {
                ...
                if (a.grid) {
                    ...
                    for (; r < y;) {
                        if (b(a.rows[r]).hasClass("jqgrow")) {
                            b(a.rows[r].cells[f]).bind("click",
                            function() {
                            ...
                            a.p.subGridOptions.expandOnLoad === true && setTimeout(function() {
                                b(tr.cells[f]).trigger("click")
                            },
                            r * a.p.subGridOptions.delayOnLoad)
                        }
                        r++
                    }
    ...
    e.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (a !== null && (typeof a === "object" || e.isFunction(a))) if (a.groupField.length) {
                    ...
                    for (var b = 0; b < a.groupField.length; b++) {
                        ...
                        if (typeof a.groupSummary[b] != "boolean") a.groupSummary[b] = false;
                        ...
                        if (a.groupSummary[b]) {
                            ...
                            d = 0,
                            g = c.length; d < g; d++) c[d].summaryType && a.summary[b].push({
                                nm: c[d].name,
                                st: c[d].summaryType,
                                v: ""
                            })
        ...
        groupingPrepare: function(a, b, c, d) {
            this.each(function() {
                b[0] += "";
                var g = b[0].toString().split(" ").join(""),
                h = this.p.groupingView,
                f = this;
                if (c.hasOwnProperty(g)) c[g].push(a);
                else {
                    c[g] = [];
                    c[g].push(a);
        ...
        groupingToggle: function(a) {
            this.each(function() {
                ...
                h = b.plusicon,
                f = e("#" + a)[0].nextSibling,
                k = e("#" + a + " span.tree-wrap-" + this.p.direction),
                l = false;
                if (k.hasClass(g)) {
        ...
        groupingRender: function(a, b) {
            return this.each(function() {
                ...
                function(o, n) {
                    f = c.p.id + "ghead_" + o;
                    h = "<span style='cursor:pointer;' class='ui-icon " + k + "'></span>";
                    try {
                        l = c.formatter(f, d.sortnames[0][o], r, d.sortitems[0])
                    } catch(v) {
                        l = d.sortnames[0][o]
                    }
                    g += '<tr id="' + f + '" role="row" class= "ui-widget-content jqgroup ui-row-' + c.p.direction + '"><td colspan="' + b + '" onclick=\'jQuery("#' + c.p.id + '").jqGrid("groupingToggle","' + f + '");return false;\'>' + h + e.jgrid.format(d.groupText[0], l, a[n].length) + "</td></tr>";
                    ...
                    if (d.groupSummary[0]) {
                        ...
                        i = d.summaryval[0][n];
                        for (var p = c.p.colModel,
                        q, s = a[n].length, j = 0; j < b; j++) {
        ...
        groupingGroupBy: function(a, b) {
            return this.each(function() {
                ...
                for (var d = 0; d < c.groupField.length; d++) ! c.groupColumnShow[d] && c.visibiltyOnNextGrouping[d] && e(this).jqGrid("showCol", c.groupField[d]);
        ...
        groupingRemove: function(a) {
            return this.each(function() {
                ...
                if (a === true) {
                    for (var b = this.p.groupingView,
                    c = 0; c < b.groupField.length; c++) ! b.groupColumnShow[c] && b.visibiltyOnNextGrouping[c] && e(this).jqGrid("showCol", b.groupField);
    ...
    d.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                var a = this;
                if (a.grid && a.p.treeGrid) for (var e = a.p.expColInd,
                g = a.p.treeReader.expanded_field,
                h = a.p.treeReader.leaf_field,
                f = a.p.treeReader.level_field,
                k = a.p.treeReader.icon_field,
                i = a.p.treeReader.loaded,
                j, o, n, l; b < c;) {
                    ...
                    if (a.p.treeGridModel == "nested") if (!l[h]) {
                        ...
                        a.rows[b].cells[a.p._treeleafpos].innerHTML = l[h]
                    }
                    j = parseInt(l[f], 10);
                    ...
                    l[g] = (l[g] == "true" || l[g] === true ? true: false) && l[i];
                    ...
                    d(a.rows[b].cells[e]).find("div.treeclick").bind("click",
                    function(m) {
                    ...
                    a.p.ExpandColClick === true && d(a.rows[b].cells[e]).find("span.cell-wrapper").css("cursor", "pointer").bind("click",
                    function(m) {
                        m = d(m.target || m.srcElement, a.rows).closest("tr.jqgrow")[0].id;
                        var r = a.p._index[m];
                        if (!a.p.data[r][h]) if (a.p.data[r][g]) {
                            d(a).jqGrid("collapseRow", a.p.data[r]);
                            d(a).jqGrid("collapseNode", a.p.data[r])
                        } else {
        ...
        setTreeGrid: function() {
            return this.each(function() {
                ...
                if (b.p.treeGrid) {
                    ...
                    b.p.treeIcons || {});
                    if (b.p.treeGridModel == "nested") b.p.treeReader = d.extend({
                        level_field: "level",
                        left_field: "lft",
                        right_field: "rgt",
                        leaf_field: "isLeaf",
        ...
        expandNode: function(b) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[c]) {
                        var k = d.jgrid.getAccessor(b, this.p.localReader.id),
                        i = d("#" + k, this.grid.bDiv)[0],
                        j = this.p._index[k];
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (k !== undefined) {
                        ...
                        if (this.p.treeGridModel === "nested") {
                            c = d.jgrid.from(this.p.data).greater(a, g, {
                                stype: "integer"
                            }).select();
                            if (c.length) for (f in c) c[f][a] = parseInt(c[f][a], 10) - h;
        ...
        addChildNode: function(b, c, a) {
            ...
            if (a) {
                ...
                k = e.p.treeReader.parent_id_field,
...
var xmlJsonClass = {
    ...
    json2xml: function(a, b) {
        var g = function(d, c, i) {
            ...
            if (d instanceof Array) if (d.length === 0) h += i + "<" + c + ">__EMPTY_ARRAY_</" + c + ">\n";
                ...
                k = false;
                h += i + "<" + c;
                for (j in d) if (d.hasOwnProperty(j)) if (j.charAt(0) === "@") h += " " + j.substr(1) + '="' + d[j].toString() + '"';
                else k = true;
                h += k ? ">": "/>";
                if (k) {
                    for (j in d) if (d.hasOwnProperty(j)) if (j === "#text") h += d[j];
                    else if (j === "#cdata") h += "<![CDATA[" + d[j] + "]]\>";
                    else if (j.charAt(0) !== "@") h += g(d[j], j, i + "\t");
    ...
    toJson: function(a, b, g, e) {
        ...
        if (a === "[]") f += b ? ":[]": "[]";
            ...
            f += (b ? ":{": "{") + (i.length > 1 ? c + g + d + i.join("," + c + g + d) + c + g: i.join("")) + "}"
...
function tableToGrid(n, o) {
    jQuery(n).each(function() {
        if (!this.grid) {
            ...
            d = jQuery("input[type=checkbox]:first", jQuery(this)),
            b = jQuery("input[type=radio]:first", jQuery(this));
            d = d.length > 0;
            b = !d && b.length > 0;
            var l = d || b,
            c = [],
        ...
        sortableColumns: function(b) {
            return this.each(function() {
                ...
                f = {
                    ...
                    placeholder: {
                        element: function(h) {
                            return a(document.createElement(h[0].nodeName)).addClass(h[0].className + " ui-sortable-placeholder ui-state-highlight").removeClass("ui-sortable-helper")[0]
                        },
                        update: function(h, j) {
        ...
        gridDnD: function(b) {
            return this.each(function() {
                ...
                if (c.grid) if (!c.p.treeGrid) if (a.fn.draggable && a.fn.droppable) {
                    ...
                    if (typeof b == "string" && b == "updateDnD" && c.p.jqgdnd === true) g();
                    else {
                        b = a.extend({
                            drag: function(e) {
                                return a.extend({
                ...
                if (g.grid && a.fn.resizable) {
                    ...
                    b.stop = function(c, f) {
                        a(g).jqGrid("setGridParam", {
                            height: a("#gview_" + g.p.id + " .ui-jqgrid-bdiv").height()
                        });
                        a(g).jqGrid("setGridWidth", f.size.width, b.shrinkToFit);
                        b._stop_ && b._stop_.call(g, c, f)
                    };
                    b.alsoResize = b._alsoResize_ ? eval("(" + ("{'#gview_" + g.p.id + " .ui-jqgrid-bdiv':true,'" + b._alsoResize_ + "':true}") + ")") : a(".ui-jqgrid-bdiv", "#gview_" + g.p.id);
...
//rq 对jqGrid的扩展
function jqGridRQExtendsInclude() {
    var pathn = window.location.pathname;
    pathn = pathn.substring(0, pathn.indexOf("/", 1));
    if (pathn == "/mis2" || pathn == "/eds") {
        pathn = "";
    }
    pathn=$.contextPath;
    var pathtojsfiles = pathn + "/mis2/gezComponents/jquery/jqgrid/js/"; // need to be ajusted
    // set include to false if you do not want some modules to be included
    var modules = [{
        include: true,
        incfile: 'grid.rqextend.js'
    } //通用方法的扩展
    ];
    var filename;
    ...
    function IncludeJavaScript(jsFile) {
		...
		*/
		var scriptHtml = '<script type="text/javaScript" src="'+jsFile+'"></script>';
		$("head").append(scriptHtml);
    }
}
jqGridRQExtendsInclude();